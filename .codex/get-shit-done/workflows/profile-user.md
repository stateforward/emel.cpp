...
Key references:
- @/Users/gabrielwillen/VSCode/stateforward/emel/emel.cpp/.codex/get-shit-done/references/ui-brand.md (display patterns)
- @/Users/gabrielwillen/VSCode/stateforward/emel/emel.cpp/.codex/get-shit-done/agents/gsd-user-profiler.md (profiler agent definition)
- @/Users/gabrielwillen/VSCode/stateforward/emel/emel.cpp/.codex/get-shit-done/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="/Users/gabrielwillen/VSCode/stateforward/emel/emel.cpp/.codex/get-shit-done/USER-PROFILE.md"
...
```bash
cp "/Users/gabrielwillen/VSCode/stateforward/emel/emel.cpp/.codex/get-shit-done/USER-PROFILE.md" "/Users/gabrielwillen/VSCode/stateforward/emel/emel.cpp/.codex/USER-PROFILE.backup.md"
```
...
✓ Stores profile at /Users/gabrielwillen/VSCode/stateforward/emel/emel.cpp/.codex/get-shit-done/USER-PROFILE.md
...
Run session scan:
```bash
SCAN_RESULT=$(node /Users/gabrielwillen/VSCode/stateforward/emel/emel.cpp/.codex/get-shit-done/bin/gsd-tools.cjs scan-sessions --json 2>/dev/null)
```
...
```bash
SAMPLE_RESULT=$(node /Users/gabrielwillen/VSCode/stateforward/emel/emel.cpp/.codex/get-shit-done/bin/gsd-tools.cjs profile-sample --json 2>/dev/null)
```
...
- The user-profiling reference doc at `/Users/gabrielwillen/VSCode/stateforward/emel/emel.cpp/.codex/get-shit-done/references/user-profiling.md`
...
Reference: @/Users/gabrielwillen/VSCode/stateforward/emel/emel.cpp/.codex/get-shit-done/references/user-profiling.md
...
**Get questions:**
```bash
QUESTIONS=$(node /Users/gabrielwillen/VSCode/stateforward/emel/emel.cpp/.codex/get-shit-done/bin/gsd-tools.cjs profile-questionnaire --json 2>/dev/null)
```
...
```bash
ANALYSIS_RESULT=$(node /Users/gabrielwillen/VSCode/stateforward/emel/emel.cpp/.codex/get-shit-done/bin/gsd-tools.cjs profile-questionnaire --answers "$ANSWERS_PATH" --json 2>/dev/null)
```
...
```bash
node /Users/gabrielwillen/VSCode/stateforward/emel/emel.cpp/.codex/get-shit-done/bin/gsd-tools.cjs write-profile --input "$ANALYSIS_PATH" --json 2>/dev/null
```

Display: "✓ Profile written to /Users/gabrielwillen/VSCode/stateforward/emel/emel.cpp/.codex/get-shit-done/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global AGENTS.md" -- "Add profile to /Users/gabrielwillen/VSCode/stateforward/emel/emel.cpp/.codex/AGENTS.md for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at /Users/gabrielwillen/VSCode/stateforward/emel/emel.cpp/.codex/get-shit-done/USER-PROFILE.md" and jump to step 10.
...
```bash
node /Users/gabrielwillen/VSCode/stateforward/emel/emel.cpp/.codex/get-shit-done/bin/gsd-tools.cjs generate-dev-preferences --analysis "$ANALYSIS_PATH" --json 2>/dev/null
```

Display: "✓ Generated $gsd-dev-preferences at /Users/gabrielwillen/VSCode/stateforward/emel/emel.cpp/.codex/commands/gsd/dev-preferences.md"

**For AGENTS.md profile section (if selected):**

```bash
node /Users/gabrielwillen/VSCode/stateforward/emel/emel.cpp/.codex/get-shit-done/bin/gsd-tools.cjs generate-agents-profile --analysis "$ANALYSIS_PATH" --json 2>/dev/null
```
...
```bash
node /Users/gabrielwillen/VSCode/stateforward/emel/emel.cpp/.codex/get-shit-done/bin/gsd-tools.cjs generate-agents-profile --analysis "$ANALYSIS_PATH" --global --json 2>/dev/null
```

Display: "✓ Added profile section to /Users/gabrielwillen/VSCode/stateforward/emel/emel.cpp/.codex/AGENTS.md"
...
```bash
BACKUP_PATH="/Users/gabrielwillen/VSCode/stateforward/emel/emel.cpp/.codex/USER-PROFILE.backup.md"
```
...
Your profile:    /Users/gabrielwillen/VSCode/stateforward/emel/emel.cpp/.codex/get-shit-done/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ $gsd-dev-preferences   /Users/gabrielwillen/VSCode/stateforward/emel/emel.cpp/.codex/commands/gsd/dev-preferences.md
  ✓ AGENTS.md section       ./AGENTS.md
  ✓ Global AGENTS.md        /Users/gabrielwillen/VSCode/stateforward/emel/emel.cpp/.codex/AGENTS.md
```
