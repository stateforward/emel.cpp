...
```bash
AUDITOR_MODEL=$(node "/Users/gabrielwillen/VSCode/stateforward/emel/emel.cpp/.codex/get-shit-done/bin/gsd-tools.cjs" resolve-model gsd-eval-auditor --raw)
```
...
```markdown
Read /Users/gabrielwillen/VSCode/stateforward/emel/emel.cpp/.codex/agents/gsd-eval-auditor.md for instructions.
