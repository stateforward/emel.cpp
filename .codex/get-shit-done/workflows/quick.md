...
```bash
INIT=$(node "/Users/gabrielwillen/VSCode/stateforward/emel/emel.cpp/.codex/get-shit-done/bin/gsd-tools.cjs" init quick "$DESCRIPTION")
...
AGENT_SKILLS_EXECUTOR=$(node "/Users/gabrielwillen/VSCode/stateforward/emel/emel.cpp/.codex/get-shit-done/bin/gsd-tools.cjs" agent-skills gsd-executor 2>/dev/null)
...
AGENT_SKILLS_VERIFIER=$(node "/Users/gabrielwillen/VSCode/stateforward/emel/emel.cpp/.codex/get-shit-done/bin/gsd-tools.cjs" agent-skills gsd-verifier 2>/dev/null)
```
...
- ./AGENTS.md, ./docs/rules/sml.rules.md, ./docs/rules/cpp.rules.md (if they exist — normative project rules; do not infer allowed patterns from conflicting code)
...
- ./AGENTS.md, ./docs/rules/sml.rules.md, ./docs/rules/cpp.rules.md (if they exist — follow these as the normative rule set)
...
- .planning/STATE.md (Project state)
- ./AGENTS.md, ./docs/rules/sml.rules.md, ./docs/rules/cpp.rules.md (Project instructions and normative rules, if they exist)
...
node "/Users/gabrielwillen/VSCode/stateforward/emel/emel.cpp/.codex/get-shit-done/bin/gsd-tools.cjs" commit "docs(quick-${quick_id}): ${DESCRIPTION}" --files ${file_list}
```
