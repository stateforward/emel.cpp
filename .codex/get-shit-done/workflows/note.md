...
- **Global scope**: `/Users/gabrielwillen/VSCode/stateforward/emel/emel.cpp/.codex/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/gabrielwillen/VSCode/stateforward/emel/emel.cpp/.codex/notes/`)
...
2. Glob `/Users/gabrielwillen/VSCode/stateforward/emel/emel.cpp/.codex/notes/*.md` (if directory exists) — global notes
...
Global (/Users/gabrielwillen/VSCode/stateforward/emel/emel.cpp/.codex/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/gabrielwillen/VSCode/stateforward/emel/emel.cpp/.codex/notes/` — works in any directory
