...
Template for project-root `AGENTS.md` — auto-generated by `gsd-tools generate-agents-md`.
...
**Fallback text:**
```
Conventions not yet established. Follow explicit rule files and documented project constraints rather than inferring conventions from checked-in code.
```
...
**Fallback text:**
```
Architecture not yet mapped. Follow explicit architectural rules and documented constraints rather than copying unchecked codebase patterns.
```
