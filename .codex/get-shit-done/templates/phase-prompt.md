...
<!-- For checkpoint task examples and patterns, see @/Users/gabrielwillen/VSCode/stateforward/emel/emel.cpp/.codex/get-shit-done/references/checkpoints.md -->
...
## Kernel Locality (`emel.cpp`)

If a plan changes operator math, lowering, packing, quant/dequant, or
backend-specific numeric work:
- `files_modified` must include the owning kernel file(s)
- `<action>` must state which non-kernel files remain orchestration-only
- Do not assign ad hoc compute to generators, planners, loaders, graph
  orchestration, wrappers, tests, or tools
Plans that change compute behavior only in non-kernel files are incomplete.
...
See `/Users/gabrielwillen/VSCode/stateforward/emel/emel.cpp/.codex/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `/Users/gabrielwillen/VSCode/stateforward/emel/emel.cpp/.codex/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `/Users/gabrielwillen/VSCode/stateforward/emel/emel.cpp/.codex/get-shit-done/workflows/verify-phase.md` for verification logic.
