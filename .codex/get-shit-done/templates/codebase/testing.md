...
**Purpose:** Document how tests are written and run. Guide for adding tests that follow the project's declared test rules and any non-conflicting local patterns.
