...
void append_emel_speech_lm_moshi_cases(std::vector<result> & results, const config & cfg);
void append_reference_speech_lm_moshi_cases(std::vector<result> & results, const config & cfg);
...
void append_reference_needle_graph_cases(std::vector<result> & results, const config & cfg);
