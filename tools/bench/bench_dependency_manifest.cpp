...
constexpr std::array k_records{
    ...
    dependency_record{"needle_graph",
                      kind::source,
                      "tools/bench/model/needle/graph_bench.cpp",
                      "suite_source"},
    dependency_record{"needle_graph",
                      kind::script,
                      "tools/bench/model/needle/cactus_reference.py",
                      "live_cactus_reference_lane"},
    dependency_record{"needle_graph",
                      kind::script,
                      "scripts/bench.sh",
                      "live_compare_orchestration"},
    dependency_record{"needle_graph",
                      kind::fixture,
                      "tests/fixtures/cact/needle-heldout-prompts.tsv",
                      "canonical_request_workload"},
    dependency_record{"needle_graph",
                      kind::source,
                      "src/emel/model/needle",
                      "needle_binder_and_graph"},
    dependency_record{"needle_graph",
                      kind::source,
                      "src/emel/cact/loader",
                      "cact_loader"},
    dependency_record{"needle_graph",
                      kind::source,
                      "src/emel/kernel/cq",
    ...
    dependency_record{"needle_graph",
                      kind::source,
                      "src/emel/kernel/swa",
                      "swa_attention_routes"},
    dependency_record{"needle_graph",
                      kind::model,
                      "tests/models/route-w4-qat.cact",
                      "pinned_model_fixture"},
