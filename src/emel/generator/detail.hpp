...
struct native_backend {
  ...
  std::vector<emel::kernel::detail::quant::block_q8_k> q8_input_chunk8_storage =
      {};
  std::vector<emel::kernel::detail::quant::block_q8_0>
      packed_q8_0_input_storage = {};
  ...
  emel::model::data::rope_type rope_type = emel::model::data::rope_type::norm;
  emel::model::data::rope_scaling_type rope_scaling_type =
      emel::model::data::rope_scaling_type::linear;
  float rope_freq_scale = 1.0f;
  int32_t rope_context_original = 0;
  ...
  std::vector<emel::graph::processor::event::lifecycle_tensor_binding>
      lifecycle_tensors = {};
...
inline emel::kernel::event::tensor_view
make_src_view(const void *data, const emel::kernel::event::dtype type,
              const uint64_t ne0, const uint64_t ne1 = 1u) noexcept {
...
inline emel::kernel::event::tensor_view
make_src_view(const float *data, const uint64_t ne0,
              const uint64_t ne1 = 1u) noexcept {
  return make_src_view(data, emel::kernel::event::dtype::f32, ne0, ne1);
}

inline emel::kernel::event::tensor_view
make_q8_k_vector_view(const emel::kernel::detail::quant::block_q8_k *data,
...
inline emel::kernel::event::tensor_view
make_q8_k_rhs_chunk4_view(const emel::kernel::detail::quant::block_q8_k *data,
                          const uint64_t cols) noexcept {
  emel::kernel::event::tensor_view tensor{};
  const size_t row_bytes = emel::kernel::detail::quantized_row_storage_bytes(
      emel::kernel::detail::dtype_q8_k, cols);
...
inline emel::kernel::event::tensor_view
make_q8_k_rhs_chunk8_view(const emel::kernel::detail::quant::block_q8_k *data,
                          const uint64_t cols) noexcept {
  emel::kernel::event::tensor_view tensor{};
  const size_t row_bytes = emel::kernel::detail::quantized_row_storage_bytes(
      emel::kernel::detail::dtype_q8_k, cols);
...
inline emel::kernel::event::tensor_view
make_q8_0_vector_view(const emel::kernel::detail::quant::block_q8_0 *data,
                      const uint64_t cols) noexcept {
  emel::kernel::event::tensor_view tensor{};
  const size_t row_bytes = emel::kernel::detail::quantized_row_storage_bytes(
...
inline emel::kernel::event::tensor_view
make_packed_q8_0_rhs_chunk4_view(const void *data,
                                 const uint64_t cols) noexcept {
  emel::kernel::event::tensor_view tensor{};
...
inline emel::kernel::event::tensor_view
make_src_view_3d(const void *data, const emel::kernel::event::dtype type,
                 const uint64_t ne0, const uint64_t ne1,
...
inline emel::kernel::event::tensor_view
make_src_view_3d(const float *data, const uint64_t ne0, const uint64_t ne1,
                 const uint64_t ne2) noexcept {
  return make_src_view_3d(data, emel::kernel::event::dtype::f32, ne0, ne1, ne2);
}

inline emel::kernel::event::tensor_view make_src_view_strided_3d(
    const void *data, const emel::kernel::event::dtype type, const uint64_t ne0,
    const uint64_t ne1, const uint64_t ne2, const uint64_t nb1,
    const uint64_t nb2) noexcept {
  emel::kernel::event::tensor_view tensor{};
  tensor.data = data;
  tensor.type = type;
  tensor.ne = {ne0, ne1, ne2, 1u};
  tensor.nb[0] = emel::kernel::detail::dtype_size_bytes(
...
inline emel::kernel::event::tensor_view
make_src_view_strided_3d(const float *data, const uint64_t ne0,
                         const uint64_t ne1, const uint64_t ne2,
                         const uint64_t nb1, const uint64_t nb2) noexcept {
  return make_src_view_strided_3d(data, emel::kernel::event::dtype::f32, ne0,
                                  ne1, ne2, nb1, nb2);
}

inline emel::kernel::event::tensor_view_mut
make_dst_view(float *data, const uint64_t ne0,
              const uint64_t ne1 = 1u) noexcept {
...
inline emel::kernel::event::tensor_view_mut
make_dst_view_3d(float *data, const uint64_t ne0, const uint64_t ne1,
                 const uint64_t ne2) noexcept {
  emel::kernel::event::tensor_view_mut tensor{};
  tensor.data = data;
  tensor.type = emel::kernel::event::dtype::f32;
...
inline emel::kernel::event::tensor_view_mut
make_batch_major_dst_view(float *data, const uint64_t rows,
                          const uint64_t cols) noexcept {
  emel::kernel::event::tensor_view_mut tensor{};
  tensor.data = data;
  tensor.type = emel::kernel::event::dtype::f32;
...
inline size_t row_storage_bytes(const tensor_record &tensor,
  ...
  if (dtype == emel::kernel::detail::dtype_q4_k_x8_bl4 ||
    ...
    return emel::kernel::detail::quant::packed_q4_k_x8_group_storage_bytes(
        static_cast<uint64_t>(cols));
  }
  ...
  if (dtype == emel::kernel::detail::dtype_q6_k_x8_q8_argmax_prepared) {
    return emel::kernel::detail::quant::
        argmax_prepared_q6_k_x8_q8_group_storage_bytes(
            static_cast<uint64_t>(cols));
  }
  return emel::kernel::detail::quantized_row_storage_bytes(
      dtype, static_cast<uint64_t>(cols));
}

inline bool
packed_q6_k_x8_logits_supported(const native_backend &backend) noexcept {
...
inline bool
prepared_q6_k_x8_q8_logits_supported(const native_backend &backend) noexcept {
#if defined(__aarch64__) && defined(__ARM_NEON) &&                             \
...
inline bool
packed_q8_0_input_path_supported(const native_backend &backend,
                                 const tensor_matrix &matrix) noexcept {
#if defined(__aarch64__) && defined(__ARM_NEON)
  if (backend.kernel_kind != emel::kernel::kernel_kind::aarch64 ||
      backend.packed_q8_0_input_storage.empty() || matrix.tensor == nullptr) {
    return false;
  }
...
inline bool
q8_0_input_path_supported(const native_backend &backend,
                          const tensor_matrix &matrix) noexcept {
#if defined(__aarch64__) && defined(__ARM_NEON)
  if (backend.kernel_kind != emel::kernel::kernel_kind::aarch64 ||
      backend.packed_q8_0_input_storage.empty() || matrix.tensor == nullptr) {
  ...
  return dtype == emel::kernel::detail::dtype_q8_0 ||
         dtype == emel::kernel::detail::dtype_q1_0_g128;
#else
  (void)backend;
  (void)matrix;
  return false;
...
inline bool
packed_q8_0_chunk4_input_path_supported(const native_backend &backend,
                                        const tensor_matrix &matrix) noexcept {
#if defined(__aarch64__) && defined(__ARM_NEON) &&                             \
    defined(__ARM_FEATURE_MATMUL_INT8)
  if (backend.kernel_kind != emel::kernel::kernel_kind::aarch64 ||
...
inline bool
q8_input_chunk4_path_supported(const native_backend &backend,
                               const tensor_matrix &matrix) noexcept {
#if defined(__aarch64__) && defined(__ARM_NEON)
  if (backend.kernel_kind != emel::kernel::kernel_kind::aarch64 ||
...
inline bool
q8_input_chunk8_path_supported(const native_backend &backend,
                               const tensor_matrix &matrix) noexcept {
#if defined(__aarch64__) && defined(__ARM_NEON) &&                             \
    defined(__ARM_FEATURE_MATMUL_INT8)
  if (backend.kernel_kind != emel::kernel::kernel_kind::aarch64 ||
      backend.q8_input_chunk8_storage.empty() || matrix.tensor == nullptr) {
    return false;
  }
...
template <chunk4_rhs_route route>
inline bool
prefill_chunk4_backend_ready(const native_backend &backend) noexcept {
    ...
    const bool residual_ok =
        block.uses_attention
            ? chunk4_matmul_backend_ready<route>(backend, block.attention_q) &&
                  chunk4_matmul_backend_ready<route>(backend,
                                                     block.attention_k) &&
                  chunk4_matmul_backend_ready<route>(backend,
                                                     block.attention_v) &&
                  chunk4_matmul_backend_ready<route>(backend,
            ...
            : backend.shortconv_kernel_size > 1 &&
                  ...
                  chunk4_matmul_backend_ready<route>(
  ...
  const bool shortconv_ok = backend.shortconv_state_size == 0 ||
                            (backend.shortconv_bcx_chunk4.size() ==
                             ...
                             backend.shortconv_conv_out_chunk4.size() ==
  ...
  return shortconv_ok &&
         ...
         backend.gate_chunk4.size() ==
             static_cast<size_t>(k_prefill_q8_chunk_rows) *
                 static_cast<size_t>(
                     backend.blocks.front().feed_forward_gate.rows) &&
         backend.up_chunk4.size() == backend.gate_chunk4.size() &&
         backend.ffn_hidden_chunk4.size() == backend.gate_chunk4.size();
}

inline bool
prefill_chunk4_q8_gemm_backend_ready(const native_backend &backend) noexcept {
...
inline bool
prefill_chunk8_q8_k_backend_ready(const native_backend &backend) noexcept {
  if (backend.blocks.empty() || backend.n_layer <= 0) {
    return false;
  }
    ...
    const bool residual_ok =
        block.uses_attention
            ? q8_input_chunk8_path_supported(backend, block.attention_q) &&
                  ...
                  q8_input_chunk8_path_supported(backend,
                                                 block.attention_output)
            : backend.shortconv_kernel_size > 1 &&
                  q8_input_chunk8_path_supported(backend,
                                                 block.shortconv_in_proj) &&
  ...
  const bool shortconv_ok = backend.shortconv_state_size == 0 ||
                            (backend.shortconv_bcx_chunk8.size() ==
                                 static_cast<size_t>(k_prefill_q8_chunk8_rows) *
                                     static_cast<size_t>(3 * backend.n_embd) &&
                             backend.shortconv_conv_out_chunk8.size() ==
...
#if defined(__aarch64__) && defined(__ARM_NEON)
  if (backend.kernel_kind != emel::kernel::kernel_kind::aarch64 ||
      backend.q8_input_storage.empty() || matrix.tensor == nullptr) {
    return false;
  }
...
inline bool
q8_input_argmax_path_supported(const native_backend &backend,
                               const tensor_matrix &matrix) noexcept {
#if defined(__aarch64__) && defined(__ARM_NEON)
...
inline bool
preselected_argmax_direct_supported(const native_backend &backend) noexcept {
#if defined(__aarch64__) && defined(__ARM_NEON)
  if (backend.kernel_kind != emel::kernel::kernel_kind::aarch64 ||
  ...
  const uint8_t dtype =
      static_cast<uint8_t>(backend.output_argmax.tensor->type);
#if defined(__ARM_FEATURE_DOTPROD)
  if (dtype == emel::kernel::detail::dtype_q6_k_x8) {
    return true;
  }
...
inline bool bind_tensor_rows(const tensor_record &tensor,
  ...
  const int32_t rows =
      tensor.n_dims > 1 ? static_cast<int32_t>(tensor.dims[1]) : 1;
  if (cols <= 0 || rows <= 0) {
    return false;
  }
...
inline bool copy_tensor_row(const tensor_record &tensor, const int32_t row,
                            std::span<float> out) noexcept {
  if (row < 0 || tensor.data == nullptr || tensor.n_dims <= 0 ||
      tensor.dims[0] <= 0) {
    return false;
  }
  ...
  case emel::kernel::event::dtype::q3_k:
    quant::dequantize_row_q3_k(
        reinterpret_cast<const quant::block_q3_k *>(src_row), out.data(), cols);
    return true;
  case emel::kernel::event::dtype::q4_k:
    quant::dequantize_row_q4_k(
        reinterpret_cast<const quant::block_q4_k *>(src_row), out.data(), cols);
    return true;
  case emel::kernel::event::dtype::q6_k:
    quant::dequantize_row_q6_k(
        reinterpret_cast<const quant::block_q6_k *>(src_row), out.data(), cols);
    return true;
  case emel::kernel::event::dtype::q8_0:
    quant::dequantize_row_q8_0(
        reinterpret_cast<const quant::block_q8_0 *>(src_row), out.data(), cols);
    return true;
  case static_cast<emel::kernel::event::dtype>(
      emel::kernel::detail::dtype_q1_0_g128):
    quant::dequantize_row_q1_0_g128(
        reinterpret_cast<const quant::block_q1_0_g128 *>(src_row), out.data(),
        cols);
    return true;
  default:
    return false;
...
inline bool dequantize_tensor_vector(const tensor_record &tensor,
  ...
  const int32_t cols =
      tensor.n_dims > 0 ? static_cast<int32_t>(tensor.dims[0]) : 0;
  const int32_t rows =
      tensor.n_dims > 1 ? static_cast<int32_t>(tensor.dims[1]) : 1;
  if (cols <= 0 || rows != 1) {
    return false;
...
inline bool is_qwen3_runtime(const native_backend &backend) noexcept {
  return backend.model != nullptr &&
         emel::model::architecture_name_view(*backend.model) == "qwen3";
}

inline bool is_lfm2_runtime(const native_backend &backend) noexcept {
  return backend.model != nullptr &&
         emel::model::architecture_name_view(*backend.model) == "lfm2";
}
...
inline bool requires_attention_qk_norm(const native_backend &backend,
  ...
  return block.uses_attention &&
         (is_qwen3_runtime(backend) || is_lfm2_runtime(backend));
}

inline const block_weights *
first_attention_block(const native_backend &backend) noexcept {
  for (const auto &block : backend.blocks) {
...
inline void reset_shortconv_cache(native_backend &backend) noexcept {
  std::fill(backend.recurrent_shortconv_cache.begin(),
            backend.recurrent_shortconv_cache.end(), 0.0f);
}
...
inline const tensor_record *select_output_projection_tensor(
  ...
  if (token_embedding == nullptr || token_embedding->data == nullptr ||
...
inline bool apply_headwise_rms_norm(std::span<float> vector,
  ...
  if (head_count <= 0 || head_dim <= 0 ||
      static_cast<size_t>(head_count) * static_cast<size_t>(head_dim) !=
          vector.size() ||
...
inline bool apply_attention_qk_norm(native_backend &backend,
                                    const block_weights &block) noexcept {
  return apply_headwise_rms_norm(backend.q, block.attention_q_norm,
                                 backend.n_head, backend.head_dim,
                                 backend.rms_epsilon) &&
         apply_headwise_rms_norm(backend.k, block.attention_k_norm,
                                 backend.n_head_kv, backend.head_dim_kv,
                                 backend.rms_epsilon);
}
...
inline bool prepare_packed_q8_0_tensor_layout(
    const tensor_record &source, const int32_t rows, const int32_t cols,
  ...
  const uint64_t group_count =
      emel::kernel::detail::quant::packed_q8_0_x4_group_count(urows);
  const size_t group_bytes =
      emel::kernel::detail::quant::packed_q8_0_x4_group_storage_bytes(ucols);
  const uint64_t storage_bytes =
      static_cast<uint64_t>(group_bytes) * group_count;
  ...
  } else if constexpr (packed_dtype ==
...
template <uint8_t packed_dtype>
inline bool
prepare_packed_q8_0_matrix_layout(tensor_matrix &matrix,
                                  packed_matrix_binding &packed) noexcept {
  if (matrix.tensor == nullptr) {
    return false;
  }
  if (static_cast<uint8_t>(matrix.tensor->type) !=
      emel::kernel::detail::dtype_q8_0) {
    return true;
  }
  if (!prepare_packed_q8_0_tensor_layout<packed_dtype>(
          *matrix.tensor, matrix.rows, matrix.cols, packed.tensor,
          packed.storage)) {
    return false;
  }
...
template <uint8_t packed_dtype>
inline bool
prepare_packed_q4_tensor_layout(const tensor_record &source, const int32_t rows,
                                const int32_t cols,
                                tensor_record &packed_tensor,
                                std::vector<uint8_t> &packed_storage) noexcept {
  if (source.data == nullptr ||
  ...
  const uint64_t ucols = static_cast<uint64_t>(cols);
  const uint64_t group_count =
      emel::kernel::detail::quant::packed_q4_k_x8_group_count(urows);
  const size_t group_bytes =
...
template <uint8_t packed_dtype>
inline bool
prepare_packed_q4_matrix_layout(tensor_matrix &matrix,
                                packed_matrix_binding &packed) noexcept {
  if (matrix.tensor == nullptr) {
    return false;
  }
...
template <uint8_t packed_dtype>
inline bool
prepare_packed_q6_tensor_layout(const tensor_record &source, const int32_t rows,
                                const int32_t cols,
                                tensor_record &packed_tensor,
                                std::vector<uint8_t> &packed_storage) noexcept {
  if (source.data == nullptr ||
  ...
  const uint64_t ucols = static_cast<uint64_t>(cols);
  const uint64_t group_count =
      emel::kernel::detail::quant::packed_q6_k_x8_group_count(urows);
  const size_t group_bytes =
      packed_dtype == emel::kernel::detail::dtype_q6_k_x8_q8_prepared
          ? emel::kernel::detail::quant::
                prepared_q6_k_x8_q8_group_storage_bytes(ucols)
...
template <uint8_t packed_dtype>
inline bool
prepare_packed_q6_matrix_layout(tensor_matrix &matrix,
                                packed_matrix_binding &packed) noexcept {
  if (matrix.tensor == nullptr) {
    return false;
  }
...
inline bool
prepare_native_matrix_layout(native_backend &backend, tensor_matrix &matrix,
                             packed_matrix_binding &packed) noexcept {
  if (matrix.tensor == nullptr) {
    return false;
  }
...
#if defined(__aarch64__) && defined(__ARM_NEON) &&                             \
    defined(__ARM_FEATURE_MATMUL_INT8)
    return prepare_packed_q4_matrix_layout<
        emel::kernel::detail::dtype_q4_k_x8_bl8>(matrix, packed);
#elif defined(__aarch64__) && defined(__ARM_NEON) &&                           \
    defined(__ARM_FEATURE_DOTPROD)
    return prepare_packed_q4_matrix_layout<
        emel::kernel::detail::dtype_q4_k_x8_bl4>(matrix, packed);
#else
    return true;
#endif
  }
...
#if defined(__aarch64__) && defined(__ARM_NEON) &&                             \
    defined(__ARM_FEATURE_MATMUL_INT8)
    return prepare_packed_q6_matrix_layout<
        emel::kernel::detail::dtype_q6_k_x8_q8_prepared>(matrix, packed);
#elif defined(__aarch64__) && defined(__ARM_NEON) &&                           \
    defined(__ARM_FEATURE_DOTPROD)
    return prepare_packed_q6_matrix_layout<emel::kernel::detail::dtype_q6_k_x8>(
        matrix, packed);
#else
    return true;
#endif
...
#if defined(__aarch64__) && defined(__ARM_NEON) &&                             \
    defined(__ARM_FEATURE_MATMUL_INT8)
  return prepare_packed_q8_0_matrix_layout<
      emel::kernel::detail::dtype_q8_0_x4_bl8>(matrix, packed);
#elif defined(__aarch64__) && defined(__ARM_NEON) &&                           \
    defined(__ARM_FEATURE_DOTPROD)
  return prepare_packed_q8_0_matrix_layout<
      emel::kernel::detail::dtype_q8_0_x4_bl4>(matrix, packed);
#else
  (void)backend;
  return true;
#endif
...
template <uint8_t packed_dtype>
inline bool
prepare_packed_q8_0_output_logits_layout(native_backend &backend) noexcept {
  ...
  if (!prepare_packed_q8_0_tensor_layout<packed_dtype>(
          *tensor, backend.output_native.rows, backend.output_native.cols,
          backend.output_packed_tensor, backend.output_packed_storage)) {
    return false;
  }
...
inline bool
prepare_packed_q8_0_output_logits(native_backend &backend) noexcept {
#if defined(__aarch64__) && defined(__ARM_NEON) &&                             \
    defined(__ARM_FEATURE_MATMUL_INT8)
  return prepare_packed_q8_0_output_logits_layout<
      emel::kernel::detail::dtype_q8_0_x4_bl8>(backend);
#elif defined(__aarch64__) && defined(__ARM_NEON) &&                           \
    defined(__ARM_FEATURE_DOTPROD)
  return prepare_packed_q8_0_output_logits_layout<
      emel::kernel::detail::dtype_q8_0_x4_bl4>(backend);
#else
  (void)backend;
  return true;
#endif
...
inline bool prepare_prepared_output_logits(native_backend &backend) noexcept {
  ...
  const size_t prepared_group_bytes =
      emel::kernel::detail::quant::prepared_q6_k_x8_q8_group_storage_bytes(
          cols);
  const size_t argmax_prepared_group_bytes = emel::kernel::detail::quant::
      argmax_prepared_q6_k_x8_q8_group_storage_bytes(cols);
  ...
  if (prepared_group_bytes == 0u || prepared_storage_bytes == 0u ||
      argmax_prepared_group_bytes == 0u ||
      argmax_prepared_storage_bytes == 0u) {
    return false;
  }

  backend.output_prepared_storage.resize(
      static_cast<size_t>(prepared_storage_bytes));
  backend.output_argmax_prepared_storage.resize(
      static_cast<size_t>(argmax_prepared_storage_bytes));
  const auto *src =
      reinterpret_cast<const emel::kernel::detail::quant::block_q6_k *>(
          tensor->data);
  ...
  backend.output_prepared_tensor.type =
      emel::kernel::detail::dtype_q6_k_x8_q8_prepared;
  ...
  backend.output_argmax_prepared_tensor.type =
      emel::kernel::detail::dtype_q6_k_x8_q8_argmax_prepared;
  backend.output_argmax_prepared_tensor.data =
      backend.output_argmax_prepared_storage.data();
  backend.output_argmax_prepared_tensor.data_size =
      argmax_prepared_storage_bytes;
...
inline bool prepare_packed_output_logits(native_backend &backend) noexcept {
  ...
  backend.output_packed_storage.resize(
      static_cast<size_t>(packed_storage_bytes));
  if (!emel::kernel::detail::quant::pack_q6_k_rows_x8(
          reinterpret_cast<const emel::kernel::detail::quant::block_q6_k *>(
              tensor->data),
          rows, cols, backend.output_packed_storage.data())) {
    return false;
  }
...
inline bool prepare_block_native_matrices(native_backend &backend) noexcept {
  for (auto &block : backend.blocks) {
    const bool residual_ok =
        block.uses_attention
            ? prepare_native_matrix_layout(backend, block.attention_q,
                                           block.attention_q_packed) &&
                  prepare_native_matrix_layout(backend, block.attention_k,
                                               block.attention_k_packed) &&
                  prepare_native_matrix_layout(backend, block.attention_v,
                                               block.attention_v_packed) &&
                  prepare_native_matrix_layout(backend, block.attention_output,
                                               block.attention_output_packed)
            : prepare_native_matrix_layout(backend, block.shortconv_in_proj,
                                           block.shortconv_in_proj_packed) &&
                  prepare_native_matrix_layout(backend,
                                               block.shortconv_out_proj,
                                               block.shortconv_out_proj_packed);
    if (!residual_ok ||
        !prepare_native_matrix_layout(backend, block.feed_forward_gate,
                                      block.feed_forward_gate_packed) ||
        !prepare_native_matrix_layout(backend, block.feed_forward_down,
                                      block.feed_forward_down_packed) ||
        !prepare_native_matrix_layout(backend, block.feed_forward_up,
    ...
    const bool residual_ok =
        block.uses_attention
            ? update_q8_input_requirement(block.attention_q, max_block_count) &&
                  update_q8_input_requirement(block.attention_k,
                                              max_block_count) &&
                  update_q8_input_requirement(block.attention_v,
                                              max_block_count) &&
                  update_q8_input_requirement(block.attention_output,
                                              max_block_count)
            : update_q8_input_requirement(block.shortconv_in_proj,
                                          max_block_count) &&
                  update_q8_input_requirement(block.shortconv_out_proj,
                                              max_block_count);
    if (!residual_ok ||
        !update_q8_input_requirement(block.feed_forward_gate,
                                     max_block_count) ||
        !update_q8_input_requirement(block.feed_forward_down,
                                     max_block_count) ||
...
inline bool
prepare_q8_input_chunk4_workspace(native_backend &backend) noexcept {
...
inline bool
prepare_q8_input_chunk8_workspace(native_backend &backend) noexcept {
...
inline bool
update_packed_q8_0_input_requirement(const tensor_matrix &matrix,
                                     size_t &max_block_count) noexcept {
  if (matrix.tensor == nullptr) {
    return true;
  }
  ...
  const uint8_t dtype = static_cast<uint8_t>(matrix.tensor->type);
  if (!emel::kernel::detail::is_packed_q8_0_vector_dtype(dtype) &&
...
inline bool
prepare_packed_q8_0_input_workspace(native_backend &backend) noexcept {
  ...
  for (const auto &block : backend.blocks) {
    const bool residual_ok =
        block.uses_attention
            ? update_packed_q8_0_input_requirement(block.attention_q,
                                                   max_block_count) &&
                  update_packed_q8_0_input_requirement(block.attention_k,
                                                       max_block_count) &&
                  update_packed_q8_0_input_requirement(block.attention_v,
                                                       max_block_count) &&
                  update_packed_q8_0_input_requirement(block.attention_output,
                                                       max_block_count)
            : update_packed_q8_0_input_requirement(block.shortconv_in_proj,
                                                   max_block_count) &&
                  update_packed_q8_0_input_requirement(block.shortconv_out_proj,
                                                       max_block_count);
    if (!residual_ok ||
        !update_packed_q8_0_input_requirement(block.feed_forward_gate,
                                              max_block_count) ||
        !update_packed_q8_0_input_requirement(block.feed_forward_down,
                                              max_block_count) ||
        !update_packed_q8_0_input_requirement(block.feed_forward_up,
                                              max_block_count)) {
      return false;
    }
  }
...
inline bool
prepare_packed_q8_0_chunk4_input_workspace(native_backend &backend) noexcept {
  ...
  const uint64_t chunk_row_count =
      static_cast<uint64_t>(k_prefill_q8_chunk_rows);
...
inline emel::kernel::event::tensor_view
make_src_view(const tensor_matrix &matrix) noexcept {
  emel::kernel::event::tensor_view tensor{};
  const uint8_t dtype = static_cast<uint8_t>(matrix.tensor->type);
...
inline int32_t append_lifecycle_tensor(native_backend &backend, void *buffer,
                                       const uint64_t buffer_bytes,
                                       const int32_t consumer_refs,
                                       const bool is_leaf) {
  const int32_t tensor_id =
      static_cast<int32_t>(backend.lifecycle_tensors.size());
  backend.lifecycle_tensors.push_back(
      emel::graph::processor::event::lifecycle_tensor_binding{
          .tensor_id = tensor_id,
          .buffer = buffer,
...
inline void append_leaf_lifecycle_tensor(native_backend &backend, void *buffer,
                                         const uint64_t buffer_bytes) {
  const int32_t tensor_id =
      append_lifecycle_tensor(backend, buffer, buffer_bytes, 0, true);
...
inline void rebuild_lifecycle_views(native_backend &backend) noexcept {
  ...
  backend.prefill_lifecycle_phase =
      emel::graph::processor::event::lifecycle_phase{
          .required_filled_ids = backend.prefill_required_ids.data(),
          .required_filled_count =
              static_cast<int32_t>(backend.prefill_required_ids.size()),
          .publish_ids = backend.prefill_publish_ids.data(),
          .publish_count =
              static_cast<int32_t>(backend.prefill_publish_ids.size()),
          .release_ids = backend.prefill_release_ids.data(),
          .release_count =
              static_cast<int32_t>(backend.prefill_release_ids.size()),
      };
  backend.decode_lifecycle_phase =
      emel::graph::processor::event::lifecycle_phase{
          .required_filled_ids = backend.decode_required_ids.data(),
          .required_filled_count =
              static_cast<int32_t>(backend.decode_required_ids.size()),
          .publish_ids = backend.decode_publish_ids.data(),
          .publish_count =
              static_cast<int32_t>(backend.decode_publish_ids.size()),
          .release_ids = backend.decode_release_ids.data(),
          .release_count =
              static_cast<int32_t>(backend.decode_release_ids.size()),
      };
...
inline void build_lifecycle(native_backend &backend) {
  ...
  append_leaf_lifecycle_tensor(
      backend, const_cast<void *>(backend.token_embedding.tensor->data),
      matrix_buffer_bytes(backend.token_embedding));
  append_leaf_lifecycle_tensor(
      backend, backend.output_norm.data(),
      static_cast<uint64_t>(backend.output_norm.size()) * sizeof(float));
  append_leaf_lifecycle_tensor(backend,
                               const_cast<void *>(backend.output.tensor->data),
                               matrix_buffer_bytes(backend.output));

  for (auto &block : backend.blocks) {
    append_leaf_lifecycle_tensor(
        backend, block.attention_norm.data(),
        static_cast<uint64_t>(block.attention_norm.size()) * sizeof(float));
    if (block.uses_attention) {
      append_leaf_lifecycle_tensor(
          backend, const_cast<void *>(block.attention_q.tensor->data),
          matrix_buffer_bytes(block.attention_q));
      append_leaf_lifecycle_tensor(
          backend, const_cast<void *>(block.attention_k.tensor->data),
          matrix_buffer_bytes(block.attention_k));
      append_leaf_lifecycle_tensor(
          backend, const_cast<void *>(block.attention_v.tensor->data),
          matrix_buffer_bytes(block.attention_v));
      if (!block.attention_q_norm.empty()) {
        append_leaf_lifecycle_tensor(
            backend, block.attention_q_norm.data(),
            static_cast<uint64_t>(block.attention_q_norm.size()) *
                sizeof(float));
      }
      if (!block.attention_k_norm.empty()) {
        append_leaf_lifecycle_tensor(
            backend, block.attention_k_norm.data(),
            static_cast<uint64_t>(block.attention_k_norm.size()) *
                sizeof(float));
      }
      append_leaf_lifecycle_tensor(
          backend, const_cast<void *>(block.attention_output.tensor->data),
          matrix_buffer_bytes(block.attention_output));
    } else {
      append_leaf_lifecycle_tensor(
          backend, const_cast<void *>(block.shortconv_in_proj.tensor->data),
          matrix_buffer_bytes(block.shortconv_in_proj));
      append_leaf_lifecycle_tensor(
          backend, const_cast<void *>(block.shortconv_out_proj.tensor->data),
          matrix_buffer_bytes(block.shortconv_out_proj));
      append_leaf_lifecycle_tensor(
          backend, block.shortconv_conv.data(),
          static_cast<uint64_t>(block.shortconv_conv.size()) * sizeof(float));
    }
    append_leaf_lifecycle_tensor(
        backend, block.feed_forward_norm.data(),
        static_cast<uint64_t>(block.feed_forward_norm.size()) * sizeof(float));
    append_leaf_lifecycle_tensor(
        backend, const_cast<void *>(block.feed_forward_gate.tensor->data),
        matrix_buffer_bytes(block.feed_forward_gate));
    append_leaf_lifecycle_tensor(
        backend, const_cast<void *>(block.feed_forward_down.tensor->data),
        matrix_buffer_bytes(block.feed_forward_down));
    append_leaf_lifecycle_tensor(
        backend, const_cast<void *>(block.feed_forward_up.tensor->data),
        matrix_buffer_bytes(block.feed_forward_up));
  }

  backend.input_tokens_tensor_id =
      append_lifecycle_tensor(backend, nullptr, 0u, 0, true);
  backend.positions_tensor_id =
      append_lifecycle_tensor(backend, nullptr, 0u, 0, true);
  backend.logits_tensor_id =
      append_lifecycle_tensor(backend, nullptr, 0u, 1, false);
  backend.key_cache_tensor_id = append_lifecycle_tensor(
      backend, backend.key_cache.data(),
      static_cast<uint64_t>(backend.key_cache.size()) * sizeof(uint16_t), 1,
      false);
  backend.value_cache_tensor_id = append_lifecycle_tensor(
      backend, backend.value_cache.data(),
      static_cast<uint64_t>(backend.value_cache.size()) * sizeof(uint16_t), 1,
      false);
...
inline void
bind_runtime_lifecycle(native_backend &backend, int32_t *input_tokens,
                       const int32_t input_token_capacity, int32_t *positions,
                       const int32_t position_capacity, float *logits,
                       const int32_t logits_capacity) noexcept {
  backend.lifecycle_tensors[static_cast<size_t>(backend.input_tokens_tensor_id)]
      .buffer = input_tokens;
  backend.lifecycle_tensors[static_cast<size_t>(backend.input_tokens_tensor_id)]
      .buffer_bytes =
      static_cast<uint64_t>(input_token_capacity) * sizeof(int32_t);
  backend.lifecycle_tensors[static_cast<size_t>(backend.positions_tensor_id)]
      .buffer = positions;
  backend.lifecycle_tensors[static_cast<size_t>(backend.positions_tensor_id)]
      .buffer_bytes =
      static_cast<uint64_t>(position_capacity) * sizeof(int32_t);
  backend.lifecycle_tensors[static_cast<size_t>(backend.logits_tensor_id)]
      .buffer = logits;
  backend.lifecycle_tensors[static_cast<size_t>(backend.logits_tensor_id)]
      .buffer_bytes = static_cast<uint64_t>(logits_capacity) * sizeof(float);
}

inline const emel::graph::processor::event::lifecycle_manifest *
reserve_lifecycle(native_backend &backend, int32_t *input_tokens,
                  const int32_t input_token_capacity, int32_t *positions,
                  const int32_t position_capacity, float *logits,
                  const int32_t logits_capacity) noexcept {
  bind_runtime_lifecycle(backend, input_tokens, input_token_capacity, positions,
                         position_capacity, logits, logits_capacity);
  return &backend.reserve_lifecycle;
}

inline const emel::graph::processor::event::lifecycle_manifest *
phase_lifecycle(native_backend &backend, int32_t *input_tokens,
                const int32_t input_token_capacity, int32_t *positions,
                const int32_t position_capacity, float *logits,
                const int32_t logits_capacity, const step_kind kind) noexcept {
  bind_runtime_lifecycle(backend, input_tokens, input_token_capacity, positions,
                         position_capacity, logits, logits_capacity);
  const std::array<const emel::graph::processor::event::lifecycle_manifest *, 2>
      manifests{
...
inline bool matmul_vector_prepared_packed_q8_0_input(
    native_backend &backend, const tensor_matrix &matrix,
    const int32_t input_cols, std::span<float> output) noexcept;
...
inline bool matmul_vector(native_backend &backend, const tensor_matrix &matrix,
                          std::span<const float> input,
                          std::span<float> output) noexcept {
  ...
  if (packed_q8_0_input_path_supported(backend, matrix)) {
    return prepare_packed_q8_0_input(backend, input) &&
           matmul_vector_prepared_packed_q8_0_input(backend, matrix,
                                                    matrix.cols, output);
  }

  if (q8_0_input_path_supported(backend, matrix)) {
    const size_t block_count =
        static_cast<size_t>(matrix.cols) / static_cast<size_t>(quant::QK8_0);
    if (block_count == 0u || block_count > backend.packed_q8_0_input_storage.size()) {
      return false;
    }

    auto q8_0_input = std::span<emel::kernel::detail::quant::block_q8_0>(
        backend.packed_q8_0_input_storage.data(), block_count);
    return quantize_vector_q8_0(input, q8_0_input) &&
           matmul_vector_q8_0_input(backend, matrix, q8_0_input, matrix.cols,
                                    output);
  }
  ...
  if (q8_input_path_supported(backend, matrix)) {
    ...
    return quantize_vector_q8_k(input, q8_input) &&
           matmul_vector_q8_input(backend, matrix, q8_input, matrix.cols,
                                  output);
  }

  emel::kernel::event::op_mul_mat ev{
      .src0 = make_src_view(matrix),
      .src1 = make_src_view(input.data(), emel::kernel::event::dtype::f32,
                            static_cast<uint64_t>(1u),
                            static_cast<uint64_t>(input.size())),
      .dst = make_dst_view(output.data(), static_cast<uint64_t>(1u),
  ...
  backend.native_q8_0_dispatch_calls += static_cast<uint64_t>(
      matrix.tensor != nullptr && static_cast<uint8_t>(matrix.tensor->type) ==
                                      emel::kernel::detail::dtype_q8_0);
  return ok;
}
...
inline bool matmul_vector_argmax(native_backend &backend,
  ...
  emel::kernel::event::op_mul_mat_argmax ev{
      ...
      .src1 = make_src_view(input.data(), emel::kernel::event::dtype::f32,
                            static_cast<uint64_t>(1u),
                            static_cast<uint64_t>(input.size())),
      .dst = make_dst_view(&selected_score, static_cast<uint64_t>(1u),
                           static_cast<uint64_t>(1u)),
      .nth = 1,
...
inline bool quantize_vector_q8_k(
  ...
  emel::kernel::detail::quant::quantize_row_q8_k_strided(
      input.data(), 1u, output.data(), static_cast<int64_t>(input.size()));
  return true;
}
...
inline bool matmul_vector_q8_input(
    ...
    std::span<const emel::kernel::detail::quant::block_q8_k> input,
    const int32_t input_cols, std::span<float> output) noexcept {
  if (matrix.cols <= 0 || matrix.rows <= 0 || input_cols != matrix.cols ||
      input_cols <= 0 || static_cast<size_t>(matrix.rows) != output.size() ||
      (input_cols % static_cast<int32_t>(quant::QK_K)) != 0 ||
      static_cast<size_t>(input_cols / static_cast<int32_t>(quant::QK_K)) !=
          input.size()) {
    return false;
  }
  ...
  emel::kernel::event::op_mul_mat ev{
      .src0 = make_src_view(matrix),
      .src1 = make_q8_k_vector_view(input.data(),
...
inline bool matmul_vector_q8_0_input(
  ...
  if (matrix.cols <= 0 || matrix.rows <= 0 || input_cols != matrix.cols ||
      ...
      static_cast<size_t>(input_cols / static_cast<int32_t>(quant::QK8_0)) !=
          input.size()) {
    return false;
  }
  ...
  emel::kernel::event::op_mul_mat ev{
      .src0 = make_src_view(matrix),
      .src1 = make_q8_0_vector_view(input.data(),
                                    static_cast<uint64_t>(input_cols)),
      .dst = make_dst_view(output.data(), static_cast<uint64_t>(1u),
                           static_cast<uint64_t>(output.size())),
      .nth = 1,
  ...
  backend.native_q8_0_dispatch_calls += static_cast<uint64_t>(
      ...
      static_cast<uint8_t>(matrix.tensor->type) ==
          emel::kernel::detail::dtype_q1_0_g128 &&
      ok);
  backend.packed_q8_0_dispatch_calls +=
      static_cast<uint64_t>(matrix.tensor != nullptr &&
...
inline bool prepare_packed_q8_0_input(native_backend &backend,
  ...
  return quantize_vector_q8_0(
      input, std::span<emel::kernel::detail::quant::block_q8_0>(
                 backend.packed_q8_0_input_storage.data(), block_count));
}

inline bool
prepare_packed_q8_0_chunk4_input(native_backend &backend,
                                 std::span<const float> input,
                                 const int32_t input_cols) noexcept {
  const size_t expected_size = static_cast<size_t>(k_prefill_q8_chunk_rows) *
                               static_cast<size_t>(input_cols);
  if (backend.packed_q8_0_chunk4_rows.empty() ||
      backend.packed_q8_0_chunk4_input_storage.empty() || input_cols <= 0 ||
  ...
  for (int32_t row = 0; row < k_prefill_q8_chunk_rows; ++row) {
    if (!quantize_vector_q8_0(
            input.subspan(static_cast<size_t>(row) *
                              static_cast<size_t>(input_cols),
                          static_cast<size_t>(input_cols)),
...
inline bool prepare_q8_chunk4_input(native_backend &backend,
  ...
  const size_t expected_size = static_cast<size_t>(k_prefill_q8_chunk_rows) *
                               static_cast<size_t>(input_cols);
  if (backend.q8_input_chunk4_storage.empty() || input_cols <= 0 ||
      input.size() != expected_size ||
...
inline bool prepare_q8_chunk8_input(native_backend &backend,
                                    std::span<const float> input,
                                    const int32_t input_cols) noexcept {
  const size_t expected_size = static_cast<size_t>(k_prefill_q8_chunk8_rows) *
                               static_cast<size_t>(input_cols);
  if (backend.q8_input_chunk8_storage.empty() || input_cols <= 0 ||
      input.size() != expected_size ||
      (static_cast<size_t>(input_cols) % quant::QK_K) != 0u) {
    return false;
  }
...
inline bool matmul_vector_prepared_packed_q8_0_input(
    native_backend &backend, const tensor_matrix &matrix,
    const int32_t input_cols, std::span<float> output) noexcept {
  if (!packed_q8_0_input_path_supported(backend, matrix) || input_cols <= 0 ||
      (input_cols % static_cast<int32_t>(quant::QK8_0)) != 0) {
    return false;
  }
...
inline bool matmul_chunk4_prepared_packed_q8_0_input(
  ...
  if (!packed_q8_0_chunk4_input_path_supported(backend, matrix) ||
      input_cols <= 0 || input_cols != matrix.cols ||
  ...
  emel::kernel::event::op_mul_mat ev{
      ...
      .dst = make_batch_major_dst_view(
          output.data(), static_cast<uint64_t>(k_prefill_q8_chunk_rows),
          static_cast<uint64_t>(matrix.rows)),
      .nth = 1,
  };
  backend.kernel.set_kind(backend.kernel_kind);
...
inline bool matmul_chunk4_q8_input(native_backend &backend,
  ...
  const size_t expected_size = static_cast<size_t>(k_prefill_q8_chunk_rows) *
                               static_cast<size_t>(matrix.rows);
  if (!q8_input_chunk4_path_supported(backend, matrix) || input_cols <= 0 ||
      input_cols != matrix.cols || output.size() != expected_size) {
    return false;
  }
...
inline bool matmul_chunk8_q8_input(native_backend &backend,
  ...
  const size_t expected_size = static_cast<size_t>(k_prefill_q8_chunk8_rows) *
                               static_cast<size_t>(matrix.rows);
  if (!q8_input_chunk8_path_supported(backend, matrix) || input_cols <= 0 ||
      input_cols != matrix.cols || output.size() != expected_size) {
    return false;
  }
  ...
  emel::kernel::event::op_mul_mat ev{
      ...
      .src1 = make_q8_k_rhs_chunk8_view(backend.q8_input_chunk8_storage.data(),
                                        static_cast<uint64_t>(input_cols)),
      .dst = make_batch_major_dst_view(
          output.data(), static_cast<uint64_t>(k_prefill_q8_chunk8_rows),
          static_cast<uint64_t>(matrix.rows)),
      .nth = 1,
  };
  backend.kernel.set_kind(backend.kernel_kind);
...
inline bool matmul_chunk4_prepared(native_backend &backend,
                                   ...
                                   std::span<float> output) noexcept {
  if constexpr (route == chunk4_rhs_route::packed_q8_0) {
    return matmul_chunk4_prepared_packed_q8_0_input(backend, matrix, input_cols,
                                                    output);
  } else {
...
inline bool matmul_chunk4(native_backend &backend, const tensor_matrix &matrix,
                          std::span<const float> input,
                          const int32_t input_cols,
                          std::span<float> output) noexcept {
  const size_t expected_input = static_cast<size_t>(k_prefill_q8_chunk_rows) *
                                static_cast<size_t>(input_cols);
  const size_t expected_output = static_cast<size_t>(k_prefill_q8_chunk_rows) *
                                 static_cast<size_t>(matrix.rows);
  if (input_cols <= 0 || input.size() != expected_input ||
  ...
  if (packed_q8_0_chunk4_input_path_supported(backend, matrix)) {
    return prepare_packed_q8_0_chunk4_input(backend, input, input_cols) &&
           matmul_chunk4_prepared_packed_q8_0_input(backend, matrix, input_cols,
                                                    output);
  }
...
inline bool matmul_vector_q8_input_argmax(
    native_backend &backend, const tensor_matrix &matrix,
    std::span<const emel::kernel::detail::quant::block_q8_k> input,
    const int32_t input_cols, int32_t &selected_index,
    float &selected_score) noexcept {
  if (matrix.cols <= 0 || matrix.rows <= 0 || input_cols != matrix.cols ||
      input_cols <= 0 ||
      (input_cols % static_cast<int32_t>(quant::QK_K)) != 0 ||
...
inline bool rms_norm(std::span<const float> input,
                     std::span<const float> weight, const float epsilon,
                     std::span<float> output) noexcept {
  ...
  const float mean =
      static_cast<float>(square_sum / static_cast<double>(input.size()));
...
inline std::span<value_type> chunk_row_span(std::span<value_type> values,
                                            const int32_t row,
                                            const int32_t cols) noexcept {
  return values.subspan(static_cast<size_t>(row) * static_cast<size_t>(cols),
                        static_cast<size_t>(cols));
}

template <int32_t chunk_rows, class value_type>
inline std::span<const value_type>
chunk_row_span(std::span<const value_type> values, const int32_t row,
               const int32_t cols) noexcept {
  return values.subspan(static_cast<size_t>(row) * static_cast<size_t>(cols),
                        static_cast<size_t>(cols));
}
...
template <class value_type>
inline std::span<const value_type>
chunk4_row_span(std::span<const value_type> values, const int32_t row,
                const int32_t cols) noexcept {
  return chunk_row_span<k_prefill_q8_chunk_rows>(values, row, cols);
}
...
template <class value_type>
inline std::span<const value_type>
chunk8_row_span(std::span<const value_type> values, const int32_t row,
                const int32_t cols) noexcept {
  return chunk_row_span<k_prefill_q8_chunk8_rows>(values, row, cols);
}

template <int32_t chunk_rows>
inline bool rms_norm_chunked(std::span<const float> input, const int32_t cols,
                             std::span<const float> weight, const float epsilon,
                             std::span<float> output) noexcept {
  const size_t expected_size =
      static_cast<size_t>(chunk_rows) * static_cast<size_t>(cols);
  if (cols <= 0 || input.size() != expected_size ||
      output.size() != expected_size) {
    return false;
  }

  for (int32_t row = 0; row < chunk_rows; ++row) {
    if (!rms_norm(chunk_row_span<chunk_rows, const float>(input, row, cols),
                  weight, epsilon,
...
inline bool rms_norm_chunk4(std::span<const float> input, const int32_t cols,
                            std::span<const float> weight, const float epsilon,
                            std::span<float> output) noexcept {
  return rms_norm_chunked<k_prefill_q8_chunk_rows>(input, cols, weight, epsilon,
                                                   output);
}

inline bool rms_norm_chunk8(std::span<const float> input, const int32_t cols,
                            std::span<const float> weight, const float epsilon,
                            std::span<float> output) noexcept {
  return rms_norm_chunked<k_prefill_q8_chunk8_rows>(input, cols, weight,
                                                    epsilon, output);
}
...
template <int32_t chunk_rows>
inline bool
apply_silu_mul_chunked(std::span<const float> gate, std::span<const float> up,
                       const int32_t cols, std::span<float> output) noexcept {
  const size_t expected_size =
      static_cast<size_t>(chunk_rows) * static_cast<size_t>(cols);
...
inline bool apply_silu_mul_chunk4(std::span<const float> gate,
                                  std::span<const float> up, const int32_t cols,
                                  std::span<float> output) noexcept {
  return apply_silu_mul_chunked<k_prefill_q8_chunk_rows>(gate, up, cols,
                                                         output);
}
...
inline bool apply_silu_mul_chunk8(std::span<const float> gate,
                                  std::span<const float> up, const int32_t cols,
                                  std::span<float> output) noexcept {
  return apply_silu_mul_chunked<k_prefill_q8_chunk8_rows>(gate, up, cols,
                                                          output);
}
...
inline float rope_yarn_ramp(const float low, const float high,
                            const int32_t dim_index) noexcept {
  const float y =
      (static_cast<float>(dim_index / 2) - low) / std::max(0.001f, high - low);
  return 1.0f - std::min(1.0f, std::max(0.0f, y));
}

inline float rope_yarn_corr_dim(const int32_t n_dims, const int32_t n_ctx_orig,
                                const float n_rot, const float base) noexcept {
  return static_cast<float>(n_dims) *
         ::logf(static_cast<float>(n_ctx_orig) /
                (n_rot * 2.0f * static_cast<float>(M_PI))) /
         (2.0f * ::logf(base));
}

inline void rope_yarn_corr_dims(const int32_t n_dims, const int32_t n_ctx_orig,
                                const float freq_base, const float beta_fast,
                                const float beta_slow,
                                float corr_dims[2]) noexcept {
  const float start =
      ::floorf(rope_yarn_corr_dim(n_dims, n_ctx_orig, beta_fast, freq_base));
  const float end =
      ::ceilf(rope_yarn_corr_dim(n_dims, n_ctx_orig, beta_slow, freq_base));
  corr_dims[0] = std::max(0.0f, start);
  corr_dims[1] = std::min(static_cast<float>(n_dims - 1), end);
}

inline void rope_yarn(const float theta_extrap, const float freq_scale,
                      const float corr_dims[2], const int32_t dim_index,
                      const float ext_factor, const float mscale,
                      float &cos_theta_out, float &sin_theta_out) noexcept {
  const float theta_interp = freq_scale * theta_extrap;
  float theta = theta_interp;
  float magnitude_scale = mscale;
  if (ext_factor != 0.0f) {
    const float ramp_mix =
        rope_yarn_ramp(corr_dims[0], corr_dims[1], dim_index) * ext_factor;
    theta = theta_interp * (1.0f - ramp_mix) + theta_extrap * ramp_mix;
    magnitude_scale *= 1.0f + 0.1f * ::logf(1.0f / freq_scale);
  }

  cos_theta_out = ::cosf(theta) * magnitude_scale;
  sin_theta_out = ::sinf(theta) * magnitude_scale;
}

inline emel::model::data::rope_type
default_rope_type_for_model(const emel::model::data &model_data) noexcept {
...
inline emel::model::data::rope_type
resolve_rope_type(const emel::model::data &model_data) noexcept {
  if (model_data.params.rope_type_value != emel::model::data::rope_type::none) {
    return model_data.params.rope_type_value;
  }
  return default_rope_type_for_model(model_data);
}

inline emel::model::data::rope_scaling_type
resolve_rope_scaling_type(const emel::model::data &model_data) noexcept {
  if (model_data.params.rope_scaling_type_value !=
...
inline bool
supported_rope_type(const emel::model::data::rope_type rope_type) noexcept {
  return rope_type == emel::model::data::rope_type::none ||
         rope_type == emel::model::data::rope_type::norm ||
         rope_type == emel::model::data::rope_type::neox;
}

inline bool supported_rope_scaling_type(
    const emel::model::data::rope_scaling_type scaling_type) noexcept {
  return scaling_type == emel::model::data::rope_scaling_type::unspecified ||
         scaling_type == emel::model::data::rope_scaling_type::none ||
         scaling_type == emel::model::data::rope_scaling_type::linear ||
         scaling_type == emel::model::data::rope_scaling_type::yarn;
}

inline float resolve_rope_freq_scale(
    const emel::model::data &model_data,
    const emel::model::data::rope_scaling_type scaling_type) noexcept {
  if (scaling_type == emel::model::data::rope_scaling_type::none) {
    return 1.0f;
  }
  if (model_data.params.rope_scaling_factor > 0.0f) {
    return 1.0f / model_data.params.rope_scaling_factor;
  }
  if (model_data.params.rope_scale_linear > 0.0f) {
    return 1.0f / model_data.params.rope_scale_linear;
  }
  return 1.0f;
}

inline int32_t resolve_rope_context_original(
    const emel::model::data &model_data,
    const emel::model::data::rope_scaling_type scaling_type) noexcept {
  if (model_data.params.rope_scaling_orig_ctx_len > 0) {
    return model_data.params.rope_scaling_orig_ctx_len;
  }
  if (scaling_type == emel::model::data::rope_scaling_type::yarn) {
    return model_data.params.n_ctx;
  }
  return 0;
}

inline float resolve_rope_ext_factor(
    const emel::model::data &model_data,
    const emel::model::data::rope_scaling_type scaling_type) noexcept {
  if (model_data.params.rope_scaling_yarn_ext_factor > 0.0f) {
    return model_data.params.rope_scaling_yarn_ext_factor;
  }
  if (scaling_type == emel::model::data::rope_scaling_type::yarn) {
    return 1.0f;
  }
...
inline float rope_mscale(const float scale, const float multiplier) noexcept {
  if (scale <= 1.0f) {
    return 1.0f;
  }
  return 0.1f * multiplier * ::logf(scale) + 1.0f;
}

inline float resolve_rope_attn_factor(const emel::model::data &model_data,
                                      const float rope_freq_scale,
                                      const float rope_ext_factor) noexcept {
  float attn_factor = model_data.params.rope_scaling_yarn_attn_factor > 0.0f
                          ? model_data.params.rope_scaling_yarn_attn_factor
                          : 1.0f;

  if (rope_ext_factor != 0.0f) {
    const float scale = rope_freq_scale > 0.0f ? 1.0f / rope_freq_scale : 1.0f;
    if (model_data.params.rope_scaling_yarn_log_multiplier != 0.0f) {
      attn_factor =
          rope_mscale(scale, 1.0f) /
          rope_mscale(scale,
                      model_data.params.rope_scaling_yarn_log_multiplier);
    } else {
      attn_factor = rope_mscale(scale, 1.0f);
    }

    const float cancel = 1.0f + 0.1f * ::logf(std::max(scale, 1.0f));
    attn_factor *= 1.0f / cancel;
  }

  if (model_data.params.rope_scaling_attn_factor > 0.0f) {
    attn_factor *= model_data.params.rope_scaling_attn_factor;
  }
  return attn_factor;
}

inline float
resolve_rope_beta_fast(const emel::model::data &model_data) noexcept {
  if (model_data.params.rope_scaling_yarn_beta_fast > 0.0f) {
    return model_data.params.rope_scaling_yarn_beta_fast;
  }
  return 32.0f;
}

inline float
resolve_rope_beta_slow(const emel::model::data &model_data) noexcept {
  if (model_data.params.rope_scaling_yarn_beta_slow > 0.0f) {
    return model_data.params.rope_scaling_yarn_beta_slow;
  }
  return 1.0f;
}

inline void apply_rope(std::span<float> vector, const int32_t head_count,
                       const int32_t head_dim, const int32_t n_rot,
                       const int32_t position, const float rope_freq_base,
                       const emel::model::data::rope_type rope_type =
                           emel::model::data::rope_type::norm,
                       const float rope_freq_scale = 1.0f,
                       const int32_t rope_context_original = 0,
                       const float rope_ext_factor = 0.0f,
                       const float rope_attn_factor = 1.0f,
                       const float rope_beta_fast = 32.0f,
                       const float rope_beta_slow = 1.0f) noexcept {
  ...
  if (rope_context_original > 0) {
    rope_yarn_corr_dims(rot_dim, rope_context_original, rope_freq_base,
                        rope_beta_fast, rope_beta_slow, corr_dims);
  }

  const bool use_neox = rope_type == emel::model::data::rope_type::neox;
  const int32_t neox_offset = rot_dim / 2;
  for (int32_t head = 0; head < head_count; ++head) {
    float *head_ptr = vector.data() + (static_cast<size_t>(head) *
                                       static_cast<size_t>(head_dim));
    float theta = static_cast<float>(position);
    if (use_neox) {
      for (int32_t dim = 0; dim < neox_offset; ++dim) {
        float cos_theta = 0.0f;
        float sin_theta = 0.0f;
        rope_yarn(theta, rope_freq_scale, corr_dims, dim * 2, rope_ext_factor,
                  rope_attn_factor, cos_theta, sin_theta);
        const float x0 = head_ptr[dim];
        const float x1 = head_ptr[dim + neox_offset];
        head_ptr[dim] = x0 * cos_theta - x1 * sin_theta;
        head_ptr[dim + neox_offset] = x0 * sin_theta + x1 * cos_theta;
        theta *= theta_scale;
      }
      continue;
    }
    ...
    for (int32_t dim = 0; dim + 1 < rot_dim; dim += 2) {
      float cos_theta = 0.0f;
      float sin_theta = 0.0f;
      rope_yarn(theta, rope_freq_scale, corr_dims, dim, rope_ext_factor,
                rope_attn_factor, cos_theta, sin_theta);
      const float x0 = head_ptr[dim];
...
inline size_t layer_cache_offset(const native_backend &backend,
                                 const int32_t layer, const int32_t position,
...
inline size_t
flash_layer_cache_layer_offset(const native_backend &backend,
                               const int32_t layer,
                               const int32_t kv_head_dim) noexcept {
  return static_cast<size_t>(layer) * static_cast<size_t>(backend.n_head_kv) *
         static_cast<size_t>(backend.n_ctx) * static_cast<size_t>(kv_head_dim);
}

inline size_t
flash_layer_cache_head_offset(const native_backend &backend,
                              const int32_t layer, const int32_t kv_head,
                              const int32_t kv_head_dim) noexcept {
  return flash_layer_cache_layer_offset(backend, layer, kv_head_dim) +
         static_cast<size_t>(kv_head) * static_cast<size_t>(backend.n_ctx) *
             static_cast<size_t>(kv_head_dim);
}

inline size_t flash_layer_cache_head_position_offset(
    const native_backend &backend, const int32_t layer, const int32_t kv_head,
    const int32_t position, const int32_t kv_head_dim) noexcept {
...
inline void store_fp16_rounded_cache(std::span<const float> src,
                                     uint16_t *dst) noexcept {
...
inline bool check_backend(const native_backend *backend,
                          int32_t *err_out) noexcept {
  if (err_out != nullptr) {
    *err_out = k_error_ok;
  }
  if (backend == nullptr || backend->model == nullptr || backend->n_embd <= 0 ||
      backend->n_head <= 0 || backend->n_head_kv <= 0 ||
      backend->n_layer <= 0 || backend->n_vocab <= 0 || backend->n_ctx <= 0 ||
      backend->head_dim <= 0 || backend->head_dim_kv <= 0 ||
...
inline const step_plan *
request_plan(const emel::graph::processor::event::execute &request,
             int32_t *err_out) noexcept {
...
store_bound_request(native_backend &backend,
  ...
  if (io == nullptr || io->token_ids == nullptr || io->token_count <= 0 ||
      ...
      static_cast<size_t>(request.positions_count) >
          backend.bound_positions.size()) {
    if (err_out != nullptr) {
      *err_out = k_error_invalid;
    }
    return false;
  ...
  std::copy_n(request.positions, request.positions_count,
              backend.bound_positions.begin());
...
inline void fill_masked_softmax_probs_ggml(
    std::span<const float> scores, const int32_t active_count,
    std::span<float> probs_out, std::span<float> rounded_probs_out) noexcept {
  ...
  for (int32_t position = 0; position < width; ++position) {
    const float weight =
        probs_out[static_cast<size_t>(position)] * inv_score_sum;
  ...
  for (int32_t head = 0; head < head_count; ++head) {
    ...
    for (int32_t position = 0; position < position_limit; ++position) {
      const size_t cache_offset =
          layer_cache_offset(backend, layer_index, position, kv_dim) +
          kv_offset;
      const float score =
          emel::kernel::detail::dot_product_f32_f16_scores(
    ...
    for (int32_t position = position_limit; position < attn_width; ++position) {
      backend.attn_scores[static_cast<size_t>(position)] =
          -std::numeric_limits<float>::infinity();
    }

    fill_masked_softmax_probs_ggml(backend.attn_scores, position_limit,
                                   backend.attn_probs,
    ...
    for (int32_t dim = 0; dim < head_dim; ++dim) {
      ...
      for (int32_t position = position_limit; position < attn_width;
           ++position) {
        backend.attn_value_column[static_cast<size_t>(position)] = 0.0f;
      }
      backend.attn_ctx[cache_offset] =
...
inline emel::kernel::event::op_flash_attn_ext
make_flash_attn_request(const native_backend &backend,
                        const int32_t layer_index,
  ...
  const size_t layer_offset =
      flash_layer_cache_layer_offset(backend, layer_index, backend.head_dim_kv);
  ...
  request.src0 = make_src_view_3d(const_cast<float *>(backend.q.data()),
                                  emel::kernel::event::dtype::f32, head_dim, 1u,
                                  head_count);
  request.src1 = make_src_view_strided_3d(
      const_cast<uint16_t *>(backend.flash_key_cache.data() + layer_offset),
      emel::kernel::event::dtype::f16, kv_head_dim, kv_tokens, kv_head_count,
  ...
  request.src2 = make_src_view_strided_3d(
      ...
      sizeof(uint16_t) * kv_head_dim,
      sizeof(uint16_t) * static_cast<uint64_t>(backend.n_ctx) * kv_head_dim);
  request.dst = make_dst_view_3d(const_cast<float *>(backend.attn_ctx.data()),
                                 head_dim, 1u, head_count);
  request.nth = 1;
...
inline bool store_attention_kv_cache(native_backend &backend,
  ...
  if (position < 0 || position >= backend.n_ctx ||
...
inline bool
run_attention_for_q_vector(native_backend &backend, const int32_t layer_index,
                           const int32_t position,
  ...
  if constexpr (mode == emel::generator::attention_mode::flash) {
    ...
    return compute_attention(backend, layer_index, position + 1,
                             backend.q_attn);
  }
}

template <emel::generator::attention_mode mode>
inline bool run_attention(native_backend &backend, const int32_t layer_index,
                          const int32_t position) noexcept {
  return run_attention_for_q_vector<mode>(backend, layer_index, position,
                                          backend.q);
}
...
inline bool run_shortconv_block(native_backend &backend,
                                ...
                                const int32_t layer_index) noexcept {
  if (backend.shortconv_kernel_size <= 0 || backend.shortconv_state_size <= 0 ||
      ...
      backend.shortconv_conv_out.size() !=
          static_cast<size_t>(backend.n_embd)) {
    return false;
  }

  if (!matmul_vector(backend, block.shortconv_in_proj, backend.norm,
                     backend.shortconv_bcx)) {
    return false;
  }

  auto b = std::span<const float>(backend.shortconv_bcx.data(),
                                  static_cast<size_t>(backend.n_embd));
  auto c = std::span<const float>(backend.shortconv_bcx.data() +
                                      static_cast<size_t>(backend.n_embd),
                                  static_cast<size_t>(backend.n_embd));
  auto x = std::span<const float>(backend.shortconv_bcx.data() +
                                      static_cast<size_t>(2 * backend.n_embd),
                                  static_cast<size_t>(backend.n_embd));

  const size_t layer_offset =
      shortconv_state_layer_offset(backend, layer_index);
  ...
  for (int32_t idx = 0; idx < backend.n_embd; ++idx) {
    ...
    float conv_sum =
        bx * kernel[static_cast<size_t>(backend.shortconv_state_size)];
    for (int32_t tap = 0; tap < backend.shortconv_state_size; ++tap) {
      conv_sum +=
          state[static_cast<size_t>(tap) * static_cast<size_t>(backend.n_embd) +
                dim] *
  ...
  if (backend.shortconv_state_size > 1) {
    const size_t move_count =
        ...
        static_cast<size_t>(backend.n_embd);
    std::memmove(state, state + static_cast<size_t>(backend.n_embd),
                 move_count * sizeof(float));
  }
  std::memcpy(state + static_cast<size_t>(backend.shortconv_state_size - 1) *
                          static_cast<size_t>(backend.n_embd),
              backend.shortconv_bx.data(),
              static_cast<size_t>(backend.n_embd) * sizeof(float));

  if (!matmul_vector(backend, block.shortconv_out_proj,
                     backend.shortconv_conv_out, backend.projected)) {
    return false;
  }
...
inline bool run_shortconv_block_chunk4(native_backend &backend,
  ...
  if (!matmul_chunk4(backend, block.shortconv_in_proj, backend.norm_chunk4,
                     backend.n_embd, backend.shortconv_bcx_chunk4)) {
    return false;
  }
  ...
  for (int32_t row = 0; row < k_prefill_q8_chunk_rows; ++row) {
    const auto bcx_row = chunk4_row_span<const float>(
        std::span<const float>(backend.shortconv_bcx_chunk4), row,
        3 * backend.n_embd);
    auto conv_out_row = chunk4_row_span<float>(
        std::span<float>(backend.shortconv_conv_out_chunk4), row,
        backend.n_embd);
    auto b = bcx_row.subspan(0u, static_cast<size_t>(backend.n_embd));
    auto c = bcx_row.subspan(static_cast<size_t>(backend.n_embd),
                             static_cast<size_t>(backend.n_embd));
    auto x = bcx_row.subspan(static_cast<size_t>(2 * backend.n_embd),
                             static_cast<size_t>(backend.n_embd));
    ...
    for (int32_t idx = 0; idx < backend.n_embd; ++idx) {
      ...
      float conv_sum =
          bx * kernel[static_cast<size_t>(backend.shortconv_state_size)];
      for (int32_t tap = 0; tap < backend.shortconv_state_size; ++tap) {
        conv_sum += state[static_cast<size_t>(tap) *
                              static_cast<size_t>(backend.n_embd) +
                          dim] *
                    kernel[static_cast<size_t>(tap)];
      }
  ...
  if (!matmul_chunk4(backend, block.shortconv_out_proj,
                     backend.shortconv_conv_out_chunk4, backend.n_embd,
                     backend.projected_chunk4) ||
      !add_chunk4_rows_in_place(backend.hidden_chunk4, backend.projected_chunk4,
                                backend.n_embd)) {
    return false;
  }
...
inline bool run_layer(native_backend &backend, const int32_t layer_index,
  ...
  if (block.uses_attention) {
    ...
    const bool qkv_shared_q8_0 =
        q8_0_input_path_supported(backend, block.attention_q) &&
        q8_0_input_path_supported(backend, block.attention_k) &&
        q8_0_input_path_supported(backend, block.attention_v);
    ...
    if (qkv_shared_packed_q8_0) {
    ...
    } else if (qkv_shared_q8_0) {
      const size_t block_count =
          static_cast<size_t>(backend.n_embd) / static_cast<size_t>(quant::QK8_0);
      if (block_count == 0u || block_count > backend.packed_q8_0_input_storage.size()) {
        return false;
      }
      auto q8_0_input = std::span<emel::kernel::detail::quant::block_q8_0>(
          backend.packed_q8_0_input_storage.data(), block_count);
      if (!quantize_vector_q8_0(backend.norm, q8_0_input) ||
          !matmul_vector_q8_0_input(backend, block.attention_q, q8_0_input,
                                    block.attention_q.cols, backend.q) ||
          !matmul_vector_q8_0_input(backend, block.attention_k, q8_0_input,
                                    block.attention_k.cols, backend.k) ||
          !matmul_vector_q8_0_input(backend, block.attention_v, q8_0_input,
                                    block.attention_v.cols, backend.v)) {
        return false;
      }
    } else if (qkv_shared_q8) {
      const size_t block_count = static_cast<size_t>(backend.n_embd) /
                                 static_cast<size_t>(quant::QK_K);
      if (block_count == 0u || block_count > backend.q8_input_storage.size()) {
        return false;
      }
      auto q8_input = std::span<emel::kernel::detail::quant::block_q8_k>(
      ...
      if (!quantize_vector_q8_k(backend.norm, q8_input) ||
          !matmul_vector_q8_input(backend, block.attention_q, q8_input,
                                  block.attention_q.cols, backend.q) ||
          !matmul_vector_q8_input(backend, block.attention_k, q8_input,
                                  block.attention_k.cols, backend.k) ||
          !matmul_vector_q8_input(backend, block.attention_v, q8_input,
                                  block.attention_v.cols, backend.v)) {
        return false;
      }
    } else if (!matmul_vector(backend, block.attention_q, backend.norm,
                              backend.q) ||
               !matmul_vector(backend, block.attention_k, backend.norm,
                              backend.k) ||
               !matmul_vector(backend, block.attention_v, backend.norm,
                              backend.v)) {
      return false;
    }
    ...
    apply_rope(backend.q, backend.n_head, backend.head_dim, backend.n_rot,
    ...
    apply_rope(backend.k, backend.n_head_kv, backend.head_dim_kv, backend.n_rot,
               position, backend.rope_freq_base, backend.rope_type,
               backend.rope_freq_scale, backend.rope_context_original,
               backend.rope_ext_factor, backend.rope_attn_factor,
               backend.rope_beta_fast, backend.rope_beta_slow);
    if (!store_attention_kv_cache(
        ...
        !matmul_vector(backend, block.attention_output, backend.attn_ctx,
                       backend.projected)) {
      return false;
    }
  ...
  } else if (!run_shortconv_block(backend, block, layer_index)) {
    return false;
  }
  ...
  const bool gate_up_shared_q8_0 =
      q8_0_input_path_supported(backend, block.feed_forward_gate) &&
      q8_0_input_path_supported(backend, block.feed_forward_up);
  ...
  if (gate_up_shared_packed_q8_0) {
    if (!prepare_packed_q8_0_input(backend, backend.norm) ||
        !matmul_vector_prepared_packed_q8_0_input(
            backend, block.feed_forward_gate, block.feed_forward_gate.cols,
            backend.gate) ||
        !matmul_vector_prepared_packed_q8_0_input(
            backend, block.feed_forward_up, block.feed_forward_up.cols,
            backend.up)) {
      return false;
    }
  } else if (gate_up_shared_q8_0) {
    const size_t block_count =
        static_cast<size_t>(backend.n_embd) / static_cast<size_t>(quant::QK8_0);
    if (block_count == 0u || block_count > backend.packed_q8_0_input_storage.size()) {
      return false;
    ...
    auto q8_0_input = std::span<emel::kernel::detail::quant::block_q8_0>(
        backend.packed_q8_0_input_storage.data(), block_count);
    if (!quantize_vector_q8_0(backend.norm, q8_0_input) ||
        !matmul_vector_q8_0_input(backend, block.feed_forward_gate, q8_0_input,
                                  block.feed_forward_gate.cols, backend.gate) ||
        !matmul_vector_q8_0_input(backend, block.feed_forward_up, q8_0_input,
                                  block.feed_forward_up.cols, backend.up)) {
      return false;
    }
    ...
    auto q8_input = std::span<emel::kernel::detail::quant::block_q8_k>(
        backend.q8_input_storage.data(), block_count);
    if (!quantize_vector_q8_k(backend.norm, q8_input) ||
        !matmul_vector_q8_input(backend, block.feed_forward_gate, q8_input,
                                block.feed_forward_gate.cols, backend.gate) ||
        !matmul_vector_q8_input(backend, block.feed_forward_up, q8_input,
                                block.feed_forward_up.cols, backend.up)) {
      return false;
    }
  } else if (!matmul_vector(backend, block.feed_forward_gate, backend.norm,
                            backend.gate) ||
             !matmul_vector(backend, block.feed_forward_up, backend.norm,
                            backend.up)) {
    return false;
  }
  ...
  if (!matmul_vector(backend, block.feed_forward_down, backend.ffn_hidden,
                     backend.projected)) {
    return false;
  }
...
inline bool run_layer_flash(native_backend &backend, const int32_t layer_index,
                            const int32_t position) noexcept {
  return run_layer<emel::generator::attention_mode::flash>(backend, layer_index,
                                                           position);
}
...
inline bool run_layer_nonflash(native_backend &backend,
                               const int32_t layer_index,
                               const int32_t position) noexcept {
  return run_layer<emel::generator::attention_mode::nonflash>(
      backend, layer_index, position);
}

inline bool compute_logits(native_backend &backend) noexcept {
  if (!rms_norm(backend.hidden, backend.output_norm, backend.rms_epsilon,
                backend.norm)) {
    return false;
  }
  ...
  const bool q8_0_logits_path =
      q8_0_input_path_supported(backend, backend.output);
  if (q8_0_logits_path) {
    const size_t block_count =
        static_cast<size_t>(backend.n_embd) / static_cast<size_t>(quant::QK8_0);
    auto q8_0_input = std::span<emel::kernel::detail::quant::block_q8_0>(
        backend.packed_q8_0_input_storage.data(), block_count);
    return quantize_vector_q8_0(backend.norm, q8_0_input) &&
           matmul_vector_q8_0_input(backend, backend.output, q8_0_input,
                                    backend.n_embd, backend.bound_logits);
  }

  const bool packed_q8_logits_path =
      q8_input_path_supported(backend, backend.output);
  if (packed_q8_logits_path) {
    ...
    return quantize_vector_q8_k(backend.norm, q8_input) &&
           matmul_vector_q8_input(backend, backend.output, q8_input,
                                  backend.n_embd, backend.bound_logits);
  }

  return matmul_vector(backend, backend.output, backend.norm,
...
inline bool compute_logits_preselected_argmax(native_backend &backend,
  ...
  const tensor_matrix &output_matrix = backend.output_argmax.tensor != nullptr
                                           ? backend.output_argmax
                                           : backend.output;
  const bool packed_q8_logits_path =
  ...
  if (packed_q8_logits_path) {
    ...
    auto q8_input = std::span<emel::kernel::detail::quant::block_q8_k>(
        backend.q8_input_storage.data(), block_count);
    return quantize_vector_q8_k(backend.norm, q8_input) &&
           matmul_vector_q8_input_argmax(backend, output_matrix, q8_input,
                                         backend.n_embd, selected_index,
                                         selected_score);
  }

  return matmul_vector_argmax(backend, output_matrix, backend.norm,
...
inline bool run_prefill_scalar_tokens(native_backend &backend,
  ...
  for (size_t token_index = token_begin; token_index < token_end;
       ++token_index) {
    ...
    if (!copy_tensor_row(*backend.token_embedding.tensor, token_id,
                         backend.hidden)) {
      return false;
    }
...
inline bool run_shortconv_block_chunk4(native_backend &backend,
  ...
  if (!prepare_chunk4_rhs<route>(backend, backend.norm_chunk4,
                                 backend.n_embd) ||
      !matmul_chunk4_prepared<route>(backend, block.shortconv_in_proj,
                                     backend.n_embd,
  ...
  if (!prepare_chunk4_rhs<route>(backend, backend.shortconv_conv_out_chunk4,
                                 backend.n_embd) ||
      !matmul_chunk4_prepared<route>(backend, block.shortconv_out_proj,
                                     backend.n_embd,
                                     backend.projected_chunk4) ||
      !add_chunk4_rows_in_place(backend.hidden_chunk4, backend.projected_chunk4,
                                backend.n_embd)) {
...
inline bool
run_shortconv_block_chunk8_q8_k(native_backend &backend,
                                const block_weights &block,
                                const int32_t layer_index) noexcept {
  if (backend.shortconv_kernel_size <= 0 || backend.shortconv_state_size <= 0 ||
      block.shortconv_in_proj.tensor == nullptr ||
  ...
  if (!prepare_q8_chunk8_input(backend, backend.norm_chunk8, backend.n_embd) ||
      !matmul_chunk8_q8_input(backend, block.shortconv_in_proj, backend.n_embd,
  ...
  for (int32_t row = 0; row < k_prefill_q8_chunk8_rows; ++row) {
    const auto bcx_row = chunk8_row_span<const float>(
        std::span<const float>(backend.shortconv_bcx_chunk8), row,
        3 * backend.n_embd);
    auto conv_out_row = chunk8_row_span<float>(
        std::span<float>(backend.shortconv_conv_out_chunk8), row,
        backend.n_embd);
    auto b = bcx_row.subspan(0u, static_cast<size_t>(backend.n_embd));
    auto c = bcx_row.subspan(static_cast<size_t>(backend.n_embd),
                             static_cast<size_t>(backend.n_embd));
  ...
  if (!prepare_q8_chunk8_input(backend, backend.shortconv_conv_out_chunk8,
                               backend.n_embd) ||
      !matmul_chunk8_q8_input(backend, block.shortconv_out_proj, backend.n_embd,
                              backend.projected_chunk8) ||
      !add_chunk8_rows_in_place(backend.hidden_chunk8, backend.projected_chunk8,
                                backend.n_embd)) {
    return false;
  }
...
template <emel::generator::attention_mode mode, chunk4_rhs_route route>
inline bool run_layer_chunk4(native_backend &backend, const int32_t layer_index,
  ...
  if (block.uses_attention) {
    if (!prepare_chunk4_rhs<route>(backend, backend.norm_chunk4,
                                   backend.n_embd) ||
        !matmul_chunk4_prepared<route>(backend, block.attention_q,
                                       backend.n_embd, backend.q_chunk4) ||
        !matmul_chunk4_prepared<route>(backend, block.attention_k,
                                       backend.n_embd, backend.k_chunk4) ||
        !matmul_chunk4_prepared<route>(backend, block.attention_v,
                                       backend.n_embd, backend.v_chunk4)) {
      return false;
    }
    ...
    for (int32_t row = 0; row < k_prefill_q8_chunk_rows; ++row) {
      const int32_t position =
          backend.bound_positions[token_base + static_cast<size_t>(row)];
      auto q_row = chunk4_row_span<float>(std::span<float>(backend.q_chunk4),
                                          row, q_dim);
      auto k_row = chunk4_row_span<float>(std::span<float>(backend.k_chunk4),
                                          row, kv_dim);
      const auto v_row = chunk4_row_span<const float>(
          std::span<const float>(backend.v_chunk4), row, kv_dim);

      if (qk_norm_runtime &&
          (!apply_headwise_rms_norm(q_row, block.attention_q_norm,
                                    backend.n_head, backend.head_dim,
                                    backend.rms_epsilon) ||
           !apply_headwise_rms_norm(k_row, block.attention_k_norm,
                                    backend.n_head_kv, backend.head_dim_kv,
                                    backend.rms_epsilon))) {
        return false;
      }

      apply_rope(q_row, backend.n_head, backend.head_dim, backend.n_rot,
                 position, backend.rope_freq_base, backend.rope_type,
                 backend.rope_freq_scale, backend.rope_context_original,
                 backend.rope_ext_factor, backend.rope_attn_factor,
                 backend.rope_beta_fast, backend.rope_beta_slow);
      apply_rope(k_row, backend.n_head_kv, backend.head_dim_kv, backend.n_rot,
                 position, backend.rope_freq_base, backend.rope_type,
                 backend.rope_freq_scale, backend.rope_context_original,
                 backend.rope_ext_factor, backend.rope_attn_factor,
                 backend.rope_beta_fast, backend.rope_beta_slow);

      if (!store_attention_kv_cache(backend, layer_index, position, k_row,
                                    v_row) ||
          !run_attention_for_q_vector<mode>(backend, layer_index, position,
                                            q_row)) {
        return false;
      }

      std::copy(backend.attn_ctx.begin(), backend.attn_ctx.end(),
    ...
    if (!prepare_chunk4_rhs<route>(backend, backend.attn_ctx_chunk4, q_dim) ||
        !matmul_chunk4_prepared<route>(backend, block.attention_output, q_dim,
                                       backend.projected_chunk4) ||
        !add_chunk4_rows_in_place(backend.hidden_chunk4,
                                  backend.projected_chunk4, backend.n_embd)) {
      return false;
    }
  ...
  if (!rms_norm_chunk4(backend.hidden_chunk4, backend.n_embd,
                       block.feed_forward_norm, backend.rms_epsilon,
                       backend.norm_chunk4)) {
    return false;
  }
  ...
  if (!prepare_chunk4_rhs<route>(backend, backend.norm_chunk4,
                                 backend.n_embd) ||
      !matmul_chunk4_prepared<route>(backend, block.feed_forward_gate,
                                     backend.n_embd, backend.gate_chunk4) ||
      !matmul_chunk4_prepared<route>(backend, block.feed_forward_up,
                                     backend.n_embd, backend.up_chunk4)) {
    return false;
  }

  if (!apply_silu_mul_chunk4(backend.gate_chunk4, backend.up_chunk4, ffn_dim,
                             backend.ffn_hidden_chunk4) ||
      !prepare_chunk4_rhs<route>(backend, backend.ffn_hidden_chunk4, ffn_dim) ||
      !matmul_chunk4_prepared<route>(backend, block.feed_forward_down, ffn_dim,
                                     backend.projected_chunk4) ||
      !add_chunk4_rows_in_place(backend.hidden_chunk4, backend.projected_chunk4,
                                backend.n_embd)) {
    return false;
...
inline bool run_layer_chunk8_q8_k(native_backend &backend,
  ...
  if (block.uses_attention) {
    if (!prepare_q8_chunk8_input(backend, backend.norm_chunk8,
                                 backend.n_embd) ||
        !matmul_chunk8_q8_input(backend, block.attention_q, backend.n_embd,
                                backend.q_chunk8) ||
        !matmul_chunk8_q8_input(backend, block.attention_k, backend.n_embd,
                                backend.k_chunk8) ||
        !matmul_chunk8_q8_input(backend, block.attention_v, backend.n_embd,
                                backend.v_chunk8)) {
      return false;
    }
    ...
    for (int32_t row = 0; row < k_prefill_q8_chunk8_rows; ++row) {
      const int32_t position =
          backend.bound_positions[token_base + static_cast<size_t>(row)];
      auto q_row = chunk8_row_span<float>(std::span<float>(backend.q_chunk8),
                                          row, q_dim);
      auto k_row = chunk8_row_span<float>(std::span<float>(backend.k_chunk8),
                                          row, kv_dim);
      const auto v_row = chunk8_row_span<const float>(
    ...
    if (!prepare_q8_chunk8_input(backend, backend.attn_ctx_chunk8, q_dim) ||
        !matmul_chunk8_q8_input(backend, block.attention_output, q_dim,
                                backend.projected_chunk8) ||
        !add_chunk8_rows_in_place(backend.hidden_chunk8,
                                  backend.projected_chunk8, backend.n_embd)) {
      return false;
    }
  ...
  if (!prepare_q8_chunk8_input(backend, backend.norm_chunk8, backend.n_embd) ||
      !matmul_chunk8_q8_input(backend, block.feed_forward_gate, backend.n_embd,
                              backend.gate_chunk8) ||
      !matmul_chunk8_q8_input(backend, block.feed_forward_up, backend.n_embd,
                              backend.up_chunk8)) {
    return false;
  }

  if (!apply_silu_mul_chunk8(backend.gate_chunk8, backend.up_chunk8, ffn_dim,
                             backend.ffn_hidden_chunk8) ||
      !prepare_q8_chunk8_input(backend, backend.ffn_hidden_chunk8, ffn_dim) ||
      !matmul_chunk8_q8_input(backend, block.feed_forward_down, ffn_dim,
                              backend.projected_chunk8) ||
      !add_chunk8_rows_in_place(backend.hidden_chunk8, backend.projected_chunk8,
                                backend.n_embd)) {
    return false;
  ...
  for (size_t token_base = 0; token_base < token_limit;
    ...
    for (int32_t row = 0; row < k_prefill_q8_chunk_rows; ++row) {
      ...
      if (token_id < 0 || token_id >= backend.token_embedding.rows ||
          position < 0 || position >= backend.n_ctx ||
          !copy_tensor_row(
              *backend.token_embedding.tensor, token_id,
              chunk4_row_span<float>(std::span<float>(backend.hidden_chunk4),
                                     row, backend.n_embd))) {
        return false;
      }
    }
    ...
    std::copy(chunk4_row_span<const float>(
                  std::span<const float>(backend.hidden_chunk4),
                  k_prefill_q8_chunk_rows - 1, backend.n_embd)
                  .begin(),
  ...
  for (size_t token_base = 0; token_base < token_limit;
    ...
    for (int32_t row = 0; row < k_prefill_q8_chunk8_rows; ++row) {
      ...
      if (token_id < 0 || token_id >= backend.token_embedding.rows ||
          ...
          !copy_tensor_row(
              *backend.token_embedding.tensor, token_id,
              chunk8_row_span<float>(std::span<float>(backend.hidden_chunk8),
                                     row, backend.n_embd))) {
        return false;
      }
    }
    ...
    std::copy(chunk8_row_span<const float>(
                  std::span<const float>(backend.hidden_chunk8),
                  k_prefill_q8_chunk8_rows - 1, backend.n_embd)
                  .begin(),
...
inline bool run_prefill_chunk4(native_backend &backend) noexcept {
  ...
  const size_t chunk_limit =
      token_count -
      (token_count % static_cast<size_t>(k_prefill_q8_chunk_rows));
  if (chunk_limit == 0u ||
...
inline bool run_prefill_chunk8_q8_k(native_backend &backend) noexcept {
  ...
  const size_t chunk_limit =
      token_count -
      (token_count % static_cast<size_t>(k_prefill_q8_chunk8_rows));
  if (chunk_limit == 0u ||
...
inline bool run_prefill_preselected_argmax(native_backend &backend,
  ...
  return compute_logits_preselected_argmax(backend, selected_index,
                                           selected_score);
}

template <emel::generator::attention_mode mode, chunk4_rhs_route route>
inline bool
run_prefill_chunk4_preselected_argmax(native_backend &backend,
                                      int32_t &selected_index,
                                      float &selected_score) noexcept {
  backend.kv_cache_tokens = 0;
  reset_shortconv_cache(backend);
...
template <emel::generator::attention_mode mode>
inline bool
run_prefill_chunk8_preselected_argmax_q8_k(native_backend &backend,
                                           int32_t &selected_index,
                                           float &selected_score) noexcept {
  backend.kv_cache_tokens = 0;
  reset_shortconv_cache(backend);
...
template <emel::generator::attention_mode mode>
inline bool
run_decode(native_backend &backend,
           const emel::graph::processor::event::execute &request) noexcept {
  if (backend.bound_token_count != 1 || backend.bound_position_count != 1 ||
      request.kv_tokens < 0 || backend.kv_cache_tokens != request.kv_tokens) {
    return false;
  }
...
inline bool run_decode_preselected_argmax(
    ...
    const emel::graph::processor::event::execute &request,
    int32_t &selected_index, float &selected_score) noexcept {
  if (backend.bound_token_count != 1 || backend.bound_position_count != 1 ||
      request.kv_tokens < 0 || backend.kv_cache_tokens != request.kv_tokens) {
    return false;
  }
...
inline emel::error::type prepare(native_backend &backend,
  ...
  backend.n_head_kv = model_data.params.n_head_kv > 0
                          ? model_data.params.n_head_kv
                          : model_data.params.n_head;
  ...
  backend.rms_epsilon =
      model_data.params.attention_layer_norm_rms_epsilon > 0.0f
          ...
          : 1.0e-5f;
  backend.rope_freq_base = model_data.params.rope_freq_base > 0.0f
                               ? model_data.params.rope_freq_base
                               : 10000.0f;
  backend.rope_type = resolve_rope_type(model_data);
  backend.rope_scaling_type = resolve_rope_scaling_type(model_data);
  backend.rope_freq_scale =
      resolve_rope_freq_scale(model_data, backend.rope_scaling_type);
  backend.rope_context_original =
      resolve_rope_context_original(model_data, backend.rope_scaling_type);
  backend.rope_ext_factor =
      resolve_rope_ext_factor(model_data, backend.rope_scaling_type);
  backend.rope_attn_factor = resolve_rope_attn_factor(
      model_data, backend.rope_freq_scale, backend.rope_ext_factor);
  backend.rope_beta_fast = resolve_rope_beta_fast(model_data);
  backend.rope_beta_slow = resolve_rope_beta_slow(model_data);

  if (backend.n_vocab <= 0 || backend.n_embd <= 0 || backend.n_head <= 0 ||
      backend.n_head_kv <= 0 || backend.n_layer <= 0 || backend.n_ctx <= 0 ||
      (backend.n_embd % backend.n_head) != 0 ||
      !supported_rope_type(backend.rope_type) ||
      !supported_rope_scaling_type(backend.rope_scaling_type) ||
      backend.rope_freq_scale <= 0.0f) {
    return emel::error::cast(emel::model::loader::error::model_invalid);
  }

  backend.head_dim = backend.n_embd / backend.n_head;
  if (!bind_tensor_rows(*backend.execution.token_embedding.tensor,
                        backend.token_embedding) ||
      !dequantize_tensor_vector(*backend.execution.output_norm.tensor,
                                backend.output_norm) ||
      !bind_output_projection(backend) || !prepare_output_logits(backend)) {
    return emel::error::cast(emel::model::loader::error::model_invalid);
  }
  ...
  for (int32_t layer = 0; layer < backend.n_layer; ++layer) {
    ...
    const bool common_ok =
        dequantize_tensor_vector(*block.attention_norm.tensor,
                                 weights.attention_norm) &&
        dequantize_tensor_vector(*block.feed_forward_norm.tensor,
                                 weights.feed_forward_norm) &&
        bind_tensor_rows(*block.feed_forward_gate.tensor,
                         weights.feed_forward_gate) &&
        bind_tensor_rows(*block.feed_forward_down.tensor,
                         weights.feed_forward_down) &&
        bind_tensor_rows(*block.feed_forward_up.tensor,
    ...
    if (weights.uses_attention) {
      const bool attention_ok =
          ...
          bind_tensor_rows(*block.attention_output.tensor,
                           weights.attention_output) &&
          (!requires_attention_qk_norm(backend, weights) ||
           dequantize_tensor_vector(*block.attention_q_norm.tensor,
                                    weights.attention_q_norm)) &&
          (!requires_attention_qk_norm(backend, weights) ||
           dequantize_tensor_vector(*block.attention_k_norm.tensor,
                                    weights.attention_k_norm));
      if (!attention_ok) {
        return emel::error::cast(emel::model::loader::error::model_invalid);
      }
      continue;
    ...
    if (!lfm2_runtime ||
        !bind_tensor_rows(*block.shortconv_in_proj.tensor,
                          weights.shortconv_in_proj) ||
        !bind_tensor_rows(*block.shortconv_out_proj.tensor,
                          weights.shortconv_out_proj) ||
    ...
    const int32_t shortconv_rows =
        static_cast<int32_t>(block.shortconv_conv.tensor->dims[1]);
    const int32_t shortconv_cols =
        static_cast<int32_t>(block.shortconv_conv.tensor->dims[0]);
    if (shortconv_rows <= 0 || shortconv_cols <= 0) {
      return emel::error::cast(emel::model::loader::error::model_invalid);
    }

    weights.shortconv_conv.resize(static_cast<size_t>(shortconv_rows) *
                                  static_cast<size_t>(shortconv_cols));
    std::memcpy(weights.shortconv_conv.data(),
  ...
  const int32_t declared_value_length =
      model_data.params.attention_value_length;
  const block_weights *attention_block = first_attention_block(backend);
  backend.head_dim = declared_key_length > 0 ? declared_key_length
                                             : backend.n_embd / backend.n_head;
  if (attention_block == nullptr) {
    return emel::error::cast(emel::model::loader::error::model_invalid);
  }
  backend.head_dim_kv =
      declared_key_length > 0
          ? declared_key_length
          : attention_block->attention_k.rows / backend.n_head_kv;
  ...
  if (backend.head_dim_kv <= 0 || backend.head_dim <= 0 || backend.n_rep <= 0 ||
      (declared_value_length > 0 &&
       declared_value_length != backend.head_dim_kv) ||
      attention_block->attention_q.cols != backend.n_embd ||
      attention_block->attention_q.rows != q_dim ||
      attention_block->attention_k.cols != backend.n_embd ||
      attention_block->attention_k.rows != kv_dim ||
      attention_block->attention_v.cols != backend.n_embd ||
      attention_block->attention_v.rows != kv_dim ||
      attention_block->attention_output.cols != q_dim ||
      attention_block->attention_output.rows != backend.n_embd ||
      static_cast<int32_t>(attention_block->attention_norm.size()) !=
          backend.n_embd ||
      static_cast<int32_t>(attention_block->feed_forward_norm.size()) !=
          backend.n_embd ||
      attention_block->feed_forward_gate.cols != backend.n_embd ||
      attention_block->feed_forward_up.cols != backend.n_embd ||
      attention_block->feed_forward_down.rows != backend.n_embd) {
    return emel::error::cast(emel::model::loader::error::model_invalid);
  }

  for (const auto &block : backend.blocks) {
    if (static_cast<int32_t>(block.attention_norm.size()) != backend.n_embd ||
        static_cast<int32_t>(block.feed_forward_norm.size()) !=
            backend.n_embd ||
    ...
    if (block.uses_attention) {
      if (block.attention_q.cols != backend.n_embd ||
          block.attention_q.rows != q_dim ||
          block.attention_k.cols != backend.n_embd ||
          block.attention_k.rows != kv_dim ||
          block.attention_v.cols != backend.n_embd ||
          block.attention_v.rows != kv_dim ||
          block.attention_output.cols != q_dim ||
    ...
    if (!lfm2_runtime || backend.shortconv_kernel_size <= 1 ||
        block.shortconv_in_proj.cols != backend.n_embd ||
  ...
  if (is_qwen3_runtime(backend) || is_lfm2_runtime(backend)) {
    for (const auto &block : backend.blocks) {
      if (block.uses_attention &&
          (static_cast<int32_t>(block.attention_q_norm.size()) !=
               backend.head_dim ||
           static_cast<int32_t>(block.attention_k_norm.size()) !=
               backend.head_dim_kv)) {
        return emel::error::cast(emel::model::loader::error::model_invalid);
      }
    }
  ...
  backend.hidden_chunk4.resize(static_cast<size_t>(k_prefill_q8_chunk_rows) *
                               static_cast<size_t>(backend.n_embd));
  backend.hidden_chunk8.resize(static_cast<size_t>(k_prefill_q8_chunk8_rows) *
                               static_cast<size_t>(backend.n_embd));
  ...
  backend.q_chunk4.resize(static_cast<size_t>(k_prefill_q8_chunk_rows) *
                          static_cast<size_t>(q_dim));
  backend.q_chunk8.resize(static_cast<size_t>(k_prefill_q8_chunk8_rows) *
                          static_cast<size_t>(q_dim));
  backend.k.resize(static_cast<size_t>(kv_dim));
  backend.k_chunk4.resize(static_cast<size_t>(k_prefill_q8_chunk_rows) *
                          static_cast<size_t>(kv_dim));
  backend.k_chunk8.resize(static_cast<size_t>(k_prefill_q8_chunk8_rows) *
                          static_cast<size_t>(kv_dim));
  ...
  backend.gate.resize(
      static_cast<size_t>(attention_block->feed_forward_gate.rows));
  ...
  backend.gate_chunk8.resize(
      static_cast<size_t>(k_prefill_q8_chunk8_rows) *
      static_cast<size_t>(attention_block->feed_forward_gate.rows));
  backend.up.resize(static_cast<size_t>(attention_block->feed_forward_up.rows));
  backend.up_chunk4.resize(
      static_cast<size_t>(k_prefill_q8_chunk_rows) *
      static_cast<size_t>(attention_block->feed_forward_up.rows));
  backend.up_chunk8.resize(
      static_cast<size_t>(k_prefill_q8_chunk8_rows) *
      static_cast<size_t>(attention_block->feed_forward_up.rows));
  backend.ffn_hidden.resize(
      static_cast<size_t>(attention_block->feed_forward_gate.rows));
...
inline bool validate(const emel::graph::processor::event::execute &request,
  ...
  auto *io = static_cast<emel::generator::compute_io *>(request.compute_ctx);
  auto *backend =
      static_cast<native_backend *>(io != nullptr ? io->backend_ctx : nullptr);
  const auto *plan = request_plan(request, err_out);
  if (plan == nullptr || !check_backend(backend, err_out)) {
    return false;
  }

  if (request.expected_outputs != plan->expected_outputs || io == nullptr ||
      io->logits == nullptr || io->logits_capacity < backend->n_vocab ||
      request.positions == nullptr ||
      request.positions_count != io->token_count || io->token_count <= 0) {
    if (err_out != nullptr) {
      *err_out = k_error_invalid;
    }
    return false;
...
inline bool validate_preselected_argmax(
    const emel::graph::processor::event::execute &request,
    int32_t *err_out) noexcept {
  auto *io = static_cast<emel::generator::compute_io *>(request.compute_ctx);
  auto *backend =
  ...
  if (request.expected_outputs != plan->expected_outputs || io == nullptr ||
      io->selected_token_out == nullptr || io->selected_score_out == nullptr ||
      request.positions == nullptr ||
      request.positions_count != io->token_count || io->token_count <= 0) {
    if (err_out != nullptr) {
      *err_out = k_error_invalid;
...
inline bool prepare_graph(const emel::graph::processor::event::execute &,
                          bool *reused_out, int32_t *err_out) noexcept {
...
template <emel::generator::attention_mode mode>
inline bool
run_kernel_mode(const emel::graph::processor::event::execute &request,
                int32_t *err_out) noexcept {
  auto *io = static_cast<emel::generator::compute_io *>(request.compute_ctx);
  auto *backend =
      static_cast<native_backend *>(io != nullptr ? io->backend_ctx : nullptr);
...
inline bool run_kernel_mode_preselected_argmax(
  ...
  const auto *plan = request_plan(request, err_out);
  if (plan == nullptr || !check_backend(backend, err_out) ||
      !backend->bound_ready || io == nullptr ||
      io->selected_token_out == nullptr || io->selected_score_out == nullptr) {
    if (err_out != nullptr) {
      *err_out = k_error_invalid;
    }
  ...
  const bool ok =
      plan->kind == step_kind::prefill
          ? run_prefill_preselected_argmax<mode>(
                *backend, *io->selected_token_out, *io->selected_score_out)
          : run_decode_preselected_argmax<mode>(*backend, request,
                                                *io->selected_token_out,
                                                *io->selected_score_out);
  if (err_out != nullptr) {
    *err_out = ok ? k_error_ok : k_error_invalid;
  }
  return ok;
...
inline bool
run_kernel_flash(const emel::graph::processor::event::execute &request,
                 int32_t *err_out) noexcept {
  return run_kernel_mode<emel::generator::attention_mode::flash>(request,
                                                                 err_out);
}

inline bool
run_kernel_nonflash(const emel::graph::processor::event::execute &request,
                    int32_t *err_out) noexcept {
  return run_kernel_mode<emel::generator::attention_mode::nonflash>(request,
                                                                    err_out);
}
...
inline bool run_kernel_prefill_chunk8_q8_k_mode(
  ...
  if (plan == nullptr || plan->kind != step_kind::prefill ||
      ...
      backend->bound_token_count < k_prefill_q8_chunk8_rows ||
      !prefill_chunk8_q8_k_backend_ready(*backend)) {
    if (err_out != nullptr) {
      *err_out = k_error_invalid;
    }
    return false;
  ...
  const bool ok = run_prefill_chunk8_q8_k<mode>(*backend);
  if (err_out != nullptr) {
    *err_out = ok ? k_error_ok : k_error_invalid;
  }
  return ok;
...
inline bool run_kernel_prefill_chunk4_mode(
  ...
  if (plan == nullptr || plan->kind != step_kind::prefill ||
      ...
      !prefill_chunk4_backend_ready<route>(*backend)) {
    if (err_out != nullptr) {
      *err_out = k_error_invalid;
    }
    return false;
  ...
  const bool ok = run_prefill_chunk4<mode, route>(*backend);
  if (err_out != nullptr) {
    *err_out = ok ? k_error_ok : k_error_invalid;
  }
  return ok;
...
inline bool run_kernel_flash_prefill_chunk4_packed_q8_0(
  ...
  return run_kernel_prefill_chunk4_mode<emel::generator::attention_mode::flash,
                                        chunk4_rhs_route::packed_q8_0>(request,
                                                                       err_out);
}
...
inline bool run_kernel_nonflash_prefill_chunk4_packed_q8_0(
  ...
  return run_kernel_prefill_chunk4_mode<
      emel::generator::attention_mode::nonflash, chunk4_rhs_route::packed_q8_0>(
      request, err_out);
}
...
inline bool run_kernel_nonflash_prefill_chunk4_q8_k(
    ...
    int32_t *err_out) noexcept {
  return run_kernel_prefill_chunk4_mode<
      emel::generator::attention_mode::nonflash, chunk4_rhs_route::q8_k>(
      request, err_out);
}
...
inline bool run_kernel_flash_preselected_argmax(
    const emel::graph::processor::event::execute &request,
    int32_t *err_out) noexcept {
  return run_kernel_mode_preselected_argmax<
      emel::generator::attention_mode::flash>(request, err_out);
}
...
inline bool run_kernel_prefill_chunk4_preselected_argmax_mode(
  ...
  if (plan == nullptr || plan->kind != step_kind::prefill ||
      !check_backend(backend, err_out) || !backend->bound_ready ||
      backend->bound_token_count < k_prefill_q8_chunk_rows ||
      !prefill_chunk4_backend_ready<route>(*backend) || io == nullptr ||
      io->selected_token_out == nullptr || io->selected_score_out == nullptr) {
    if (err_out != nullptr) {
      *err_out = k_error_invalid;
    }
  ...
  const bool ok = run_prefill_chunk4_preselected_argmax<mode, route>(
      *backend, *io->selected_token_out, *io->selected_score_out);
  if (err_out != nullptr) {
    *err_out = ok ? k_error_ok : k_error_invalid;
  }
...
inline bool run_kernel_prefill_chunk8_preselected_argmax_q8_k_mode(
  ...
  if (plan == nullptr || plan->kind != step_kind::prefill ||
      !check_backend(backend, err_out) || !backend->bound_ready ||
      backend->bound_token_count < k_prefill_q8_chunk8_rows ||
      !prefill_chunk8_q8_k_backend_ready(*backend) || io == nullptr ||
      io->selected_token_out == nullptr || io->selected_score_out == nullptr) {
    if (err_out != nullptr) {
      *err_out = k_error_invalid;
    }
  ...
  const bool ok = run_prefill_chunk8_preselected_argmax_q8_k<mode>(
      *backend, *io->selected_token_out, *io->selected_score_out);
  if (err_out != nullptr) {
    *err_out = ok ? k_error_ok : k_error_invalid;
  }
...
inline bool run_kernel_flash_prefill_chunk4_preselected_argmax_packed_q8_0(
  ...
  return run_kernel_prefill_chunk4_preselected_argmax_mode<
      emel::generator::attention_mode::flash, chunk4_rhs_route::packed_q8_0>(
      request, err_out);
}
...
inline bool run_kernel_flash_prefill_chunk4_preselected_argmax_q8_k(
    ...
    int32_t *err_out) noexcept {
  return run_kernel_prefill_chunk4_preselected_argmax_mode<
      emel::generator::attention_mode::flash, chunk4_rhs_route::q8_k>(request,
                                                                      err_out);
}
...
inline bool
extract_outputs(const emel::graph::processor::event::execute &request,
                int32_t *outputs_out, int32_t *err_out) noexcept {
  auto *io = static_cast<emel::generator::compute_io *>(request.compute_ctx);
  auto *backend =
      static_cast<native_backend *>(io != nullptr ? io->backend_ctx : nullptr);
  if (!check_backend(backend, err_out) || io == nullptr ||
      io->logits == nullptr || io->logits_capacity < backend->n_vocab ||
  ...
  std::copy(backend->bound_logits.begin(), backend->bound_logits.end(),
            io->logits);
...
inline bool extract_preselected_argmax(
    const emel::graph::processor::event::execute &request, int32_t *outputs_out,
    int32_t *err_out) noexcept {
  auto *io = static_cast<emel::generator::compute_io *>(request.compute_ctx);
  auto *backend =
      static_cast<native_backend *>(io != nullptr ? io->backend_ctx : nullptr);
