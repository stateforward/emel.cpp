...
inline bool dispatch_initializer_run(
    void * actor,
    const emel::text::generator::initializer::event::run & ev) noexcept {
  return static_cast<emel::text::generator::initializer::sm *>(actor)->process_event(ev);
}

inline bool dispatch_prefill_run(void * actor,
                                 const emel::text::generator::prefill::event::run & ev) noexcept {
...
struct model {
  auto operator()() const {
    ...
    return sml::make_transition_table(
      ...
      , sml::state<generate_ready_error_channel_decision> <= sml::state<decode_compute_flash>
                 + sml::completion<event::generate_run>
                 [ guard::guard_decode_compute_invalid_request{} ]
                 / action::mark_invalid_request
      ...
      , sml::state<decode_compute_flash_decision> <= sml::state<decode_compute_flash>
                 ...
                 / action::request_decode_compute_flash_kernel

      , sml::state<generate_ready_error_channel_decision> <= sml::state<decode_compute_nonflash>
                 + sml::completion<event::generate_run>
                 [ guard::guard_decode_compute_invalid_request{} ]
                 / action::mark_invalid_request
      ...
      , sml::state<decode_compute_nonflash_decision> <= sml::state<decode_compute_nonflash>
                 + sml::completion<event::generate_run>
                 [ guard::guard_decode_materialized_scalar_packed_q8_0_ready{} ]
                 / action::request_decode_compute_nonflash_packed_q8_0

      , sml::state<decode_compute_nonflash_decision> <= sml::state<decode_compute_nonflash>
                 + sml::completion<event::generate_run>
                 [ guard::guard_decode_materialized_scalar_q8_k_ready{} ]
                 / action::request_decode_compute_nonflash_q8_k

      , sml::state<decode_compute_nonflash_decision> <= sml::state<decode_compute_nonflash>
                 + sml::completion<event::generate_run>
                 [ guard::guard_decode_materialized_scalar_native_quantized_q8_k_ready{} ]
                 / action::request_decode_compute_nonflash_native_quantized_q8_k_logits

      , sml::state<decode_compute_nonflash_decision> <= sml::state<decode_compute_nonflash>
                 + sml::completion<event::generate_run>
                 [ guard::guard_decode_materialized_scalar_native_quantized_kernel_ready{} ]
                 / action::request_decode_compute_nonflash_native_quantized

      , sml::state<decode_compute_nonflash_decision> <= sml::state<decode_compute_nonflash>
                 + sml::completion<event::generate_run>
                 [ guard::guard_decode_materialized_scalar_kernel_ready{} ]
                 / action::request_decode_compute_nonflash_kernel

      , sml::state<generate_ready_error_channel_decision> <=
               sml::state<decode_compute_flash_preselected_argmax>
                 + sml::completion<event::generate_run>
                 [ guard::guard_decode_preselected_compute_invalid_request{} ]
                 / action::mark_invalid_request
      ...
      , sml::state<decode_compute_flash_preselected_argmax_decision> <=
               sml::state<decode_compute_flash_preselected_argmax>
                 + sml::completion<event::generate_run>
                 [ guard::guard_decode_preselected_argmax_kernel_ready{} ]
                 / action::request_decode_compute_flash_preselected_argmax_kernel
      ...
      , sml::state<decode_compute_nonflash_preselected_argmax_decision> <=
               sml::state<decode_compute_nonflash_preselected_argmax>
                 + sml::completion<event::generate_run>
                 [ guard::guard_decode_preselected_argmax_q8_k_ready{} ]
                 / action::request_decode_compute_nonflash_preselected_argmax_q8_k

      , sml::state<decode_compute_nonflash_preselected_argmax_decision> <=
               sml::state<decode_compute_nonflash_preselected_argmax>
                 + sml::completion<event::generate_run>
                 [ guard::guard_decode_preselected_argmax_native_quantized_q8_k_ready{} ]
                 / action::request_decode_compute_nonflash_preselected_argmax_native_quantized_q8_k

      , sml::state<decode_compute_nonflash_preselected_argmax_decision> <=
               sml::state<decode_compute_nonflash_preselected_argmax>
                 + sml::completion<event::generate_run>
                 [ guard::guard_decode_preselected_argmax_native_quantized_kernel_ready{} ]
                 / action::request_decode_compute_nonflash_preselected_argmax_native_quantized_kernel

      , sml::state<decode_compute_nonflash_preselected_argmax_decision> <=
               sml::state<decode_compute_nonflash_preselected_argmax>
                 + sml::completion<event::generate_run>
                 [ guard::guard_decode_preselected_argmax_kernel_ready{} ]
                 / action::request_decode_compute_nonflash_preselected_argmax_kernel
      ...
      , sml::state<uninitialized> <= sml::state<uninitialized>
                 + sml::event<event::capture_graph_lifecycle>
                 [ guard::graph_lifecycle_runtime_tensor_available{} ]
                 / action::capture_graph_lifecycle_with_runtime_tensor
