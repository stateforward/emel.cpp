...
namespace emel::text::generator::prefill {
...
struct model {
  auto operator()() const {
    ...
    return sml::make_transition_table(
      ...
      , sml::state<idle> <= sml::state<contract_flash_decision>
                 + sml::completion<event::run>
                 [ guard::guard_compute_invalid_request{} ]
                 / action::mark_invalid_request
      ...
      , sml::state<compute_result_decision> <= sml::state<contract_flash_decision>
                 + sml::completion<event::run>
                 [ guard::guard_materialized_logits_with_scalar_packed_q8_0_ready{} ]
                 / action::request_contract_flash_materialized_scalar_packed_q8_0

      , sml::state<compute_result_decision> <= sml::state<contract_flash_decision>
                 + sml::completion<event::run>
                 [ guard::guard_materialized_logits_with_scalar_q8_k_ready{} ]
                 / action::request_contract_flash_materialized_scalar_q8_k

      , sml::state<compute_result_decision> <= sml::state<contract_flash_decision>
                 + sml::completion<event::run>
                 [ guard::guard_materialized_logits_with_scalar_native_quantized_q8_k_ready{} ]
                 / action::request_contract_flash_materialized_scalar_native_quantized_q8_k

      , sml::state<compute_result_decision> <= sml::state<contract_flash_decision>
                 + sml::completion<event::run>
                 [ guard::guard_materialized_logits_with_scalar_native_quantized_kernel_ready{} ]
                 / action::request_contract_flash_materialized_scalar_native_quantized
      ...
      , sml::state<compute_result_decision> <= sml::state<contract_flash_decision>
                 + sml::completion<event::run>
                 [ guard::guard_preselected_argmax_with_scalar_q8_k_ready{} ]
                 / action::request_contract_flash_preselected_scalar_q8_k

      , sml::state<compute_result_decision> <= sml::state<contract_flash_decision>
                 + sml::completion<event::run>
                 [ guard::guard_preselected_argmax_with_scalar_native_quantized_q8_k_ready{} ]
                 / action::request_contract_flash_preselected_scalar_native_quantized_q8_k

      , sml::state<compute_result_decision> <= sml::state<contract_flash_decision>
                 + sml::completion<event::run>
                 [ guard::guard_preselected_argmax_with_scalar_native_quantized_kernel_ready{} ]
                 / action::request_contract_flash_preselected_scalar_native_quantized_kernel

      , sml::state<compute_result_decision> <= sml::state<contract_flash_decision>
                 + sml::completion<event::run>
                 [ guard::guard_preselected_argmax_with_scalar_kernel_ready{} ]
                 / action::request_contract_flash_preselected_scalar_kernel

      , sml::state<idle> <= sml::state<contract_nonflash_decision>
                 + sml::completion<event::run>
                 [ guard::guard_compute_invalid_request{} ]
                 / action::mark_invalid_request
      ...
      , sml::state<compute_result_decision> <= sml::state<contract_nonflash_decision>
                 + sml::completion<event::run>
                 [ guard::guard_materialized_logits_with_scalar_packed_q8_0_ready{} ]
                 / action::request_contract_nonflash_materialized_scalar_packed_q8_0

      , sml::state<compute_result_decision> <= sml::state<contract_nonflash_decision>
                 + sml::completion<event::run>
                 [ guard::guard_materialized_logits_with_scalar_q8_k_ready{} ]
                 / action::request_contract_nonflash_materialized_scalar_q8_k

      , sml::state<compute_result_decision> <= sml::state<contract_nonflash_decision>
                 + sml::completion<event::run>
                 [ guard::guard_materialized_logits_with_scalar_native_quantized_q8_k_ready{} ]
                 / action::request_contract_nonflash_materialized_scalar_native_quantized_q8_k

      , sml::state<compute_result_decision> <= sml::state<contract_nonflash_decision>
                 + sml::completion<event::run>
                 [ guard::guard_materialized_logits_with_scalar_native_quantized_kernel_ready{} ]
                 / action::request_contract_nonflash_materialized_scalar_native_quantized

      , sml::state<compute_result_decision> <= sml::state<contract_nonflash_decision>
                 + sml::completion<event::run>
                 [ guard::guard_materialized_logits_with_scalar_kernel_ready{} ]
                 / action::request_contract_nonflash_materialized_scalar_kernel
      ...
      , sml::state<compute_result_decision> <= sml::state<contract_nonflash_decision>
                 + sml::completion<event::run>
                 [ guard::guard_preselected_argmax_with_scalar_q8_k_ready{} ]
                 / action::request_contract_nonflash_preselected_scalar_q8_k

      , sml::state<compute_result_decision> <= sml::state<contract_nonflash_decision>
                 + sml::completion<event::run>
                 [ guard::guard_preselected_argmax_with_scalar_native_quantized_q8_k_ready{} ]
                 / action::request_contract_nonflash_preselected_scalar_native_quantized_q8_k

      , sml::state<compute_result_decision> <= sml::state<contract_nonflash_decision>
                 + sml::completion<event::run>
                 [ guard::guard_preselected_argmax_with_scalar_native_quantized_kernel_ready{} ]
                 / action::request_contract_nonflash_preselected_scalar_native_quantized_kernel

      , sml::state<compute_result_decision> <= sml::state<contract_nonflash_decision>
                 + sml::completion<event::run>
                 [ guard::guard_preselected_argmax_with_scalar_kernel_ready{} ]
                 / action::request_contract_nonflash_preselected_scalar_kernel
