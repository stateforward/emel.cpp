...
namespace emel::text::generator::events {
...
struct diagnostics {
  ...
  uint64_t kernel_dispatch_calls = 0u;
  uint64_t native_q8_0_dispatch_calls = 0u;
  uint64_t packed_q8_0_dispatch_calls = 0u;
  uint64_t flash_attention_dispatch_calls = 0u;
  ...
  uint32_t native_quantized_stage_count = 0u;
  uint32_t approved_dense_f32_stage_count = 0u;
  uint32_t disallowed_fallback_stage_count = 0u;
  uint32_t explicit_no_claim_stage_count = 0u;
};

struct graph_lifecycle_snapshot {
  const emel::graph::event::reserve_output * reservation = nullptr;
  emel::graph::tensor::event::tensor_state first_tensor = {};
  emel::graph::tensor::event::tensor_state runtime_tensor = {};
  emel::error::type first_tensor_err = {};
  emel::error::type runtime_tensor_err = {};
  bool first_tensor_captured = false;
  bool runtime_tensor_captured = false;
};

}  // namespace emel::text::generator

namespace emel::text::generator::event {

struct initialize {
  initialize(void * tokenizer_sm_ref,
             emel::text::generator::tokenizer_bind_dispatch_fn & dispatch_tokenizer_bind_ref,
             emel::text::generator::tokenizer_tokenize_dispatch_fn & dispatch_tokenizer_tokenize_ref,
  ...
  emel::text::generator::tokenizer_bind_dispatch_fn & dispatch_tokenizer_bind;
  emel::text::generator::tokenizer_tokenize_dispatch_fn & dispatch_tokenizer_tokenize;
  ...
  emel::text::generator::selection_mode selection_mode =
...
struct generate_ctx {
  ...
  bool phase_accepted = false;
  int32_t phase_code = 0;
  emel::text::generator::prefill_compute_contract prefill_contract =
...
struct capture_diagnostics {
  explicit capture_diagnostics(emel::text::generator::diagnostics & out_ref) noexcept
    : out(out_ref) {}
...
struct capture_graph_lifecycle {
  explicit capture_graph_lifecycle(
      emel::text::generator::graph_lifecycle_snapshot & out_ref) noexcept
    : out(out_ref) {}

  emel::text::generator::graph_lifecycle_snapshot & out;
};
