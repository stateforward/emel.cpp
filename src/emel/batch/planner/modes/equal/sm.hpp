...
struct model {
  auto operator()() const {
    ...
    return sml::make_transition_table(
      ...
      , sml::state<planning_mode_decision> <= sml::state<planning> + sml::completion<event::request>
      //------------------------------------------------------------------------------//
      , sml::state<planning_fast_path> <= sml::state<planning_mode_decision>
          + sml::completion<event::request> [ guard::mode_is_primary_fast_path ]
      , sml::state<planning_general> <= sml::state<planning_mode_decision>
          + sml::completion<event::request>
      //------------------------------------------------------------------------------//
      , sml::state<planning_decision> <= sml::state<planning_fast_path>
          + sml::completion<event::request> / action::create_plan_primary_fast_path
      , sml::state<planning_decision> <= sml::state<planning_general>
          + sml::completion<event::request> / action::create_plan_general
      //------------------------------------------------------------------------------//
      ...
      , sml::state<unexpected_event> <= sml::state<planning_mode_decision> + sml::unexpected_event<sml::_>
      , sml::state<unexpected_event> <= sml::state<planning_fast_path> + sml::unexpected_event<sml::_>
      , sml::state<unexpected_event> <= sml::state<planning_general> + sml::unexpected_event<sml::_>
