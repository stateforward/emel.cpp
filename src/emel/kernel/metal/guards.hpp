...
template <>
struct valid_impl<::emel::kernel::metal::event::dispatch_op_dup> {
  static bool check(const ::emel::kernel::metal::event::dispatch_op_dup & ev,
...
template <>
struct valid_impl<::emel::kernel::metal::event::dispatch_op_add> {
  static bool check(const ::emel::kernel::metal::event::dispatch_op_add & ev,
                    const action::context &) noexcept {
...
template <>
struct valid_impl<::emel::kernel::metal::event::dispatch_op_mul> {
  static bool check(const ::emel::kernel::metal::event::dispatch_op_mul & ev,
                    const action::context &) noexcept {
    return ev.request.src0 != nullptr && ev.request.src1 != nullptr &&
           ev.request.dst != nullptr && ev.request.element_count > 0;
  }
...
template <>
struct valid_impl<::emel::kernel::metal::event::dispatch_op_mul_mat> {
  static bool check(const ::emel::kernel::metal::event::dispatch_op_mul_mat & ev,
                    const action::context &) noexcept {
    return ev.request.src0 != nullptr && ev.request.src1 != nullptr &&
...
template <>
struct valid_impl<::emel::kernel::metal::event::dispatch_op_rope> {
  static bool check(const ::emel::kernel::metal::event::dispatch_op_rope & ev,
                    const action::context &) noexcept {
    return ev.request.src0 != nullptr && ev.request.dst != nullptr &&
...
template <>
struct valid_impl<::emel::kernel::metal::event::dispatch_op_soft_max> {
  static bool check(const ::emel::kernel::metal::event::dispatch_op_soft_max & ev,
                    const action::context &) noexcept {
    return ev.request.src0 != nullptr && ev.request.dst != nullptr &&
           ev.request.element_count > 0;
  }
...
#define EMEL_KERNEL_DECLARE_GUARD_ALIAS(op_name)                                    \
  using valid_##op_name =                                                           \
      valid_op<::emel::kernel::metal::event::dispatch_##op_name>;            \
  using invalid_##op_name =                                                         \
      invalid_op<::emel::kernel::metal::event::dispatch_##op_name>;
