...
using exec_scaffold_t = detail::exec_op<::emel::kernel::wasm::event::dispatch_scaffold>;

#define EMEL_KERNEL_DECLARE_RUN_TYPE(op_name)                                \
  using exec_##op_name##_t =                                                  \
      detail::exec_op<::emel::kernel::wasm::event::dispatch_##op_name>;
...
#define EMEL_KERNEL_DECLARE_REJECT_TYPE(op_name)                                      \
  using reject_invalid_##op_name##_t =                                                \
      detail::reject_op<::emel::kernel::wasm::event::dispatch_##op_name>;
