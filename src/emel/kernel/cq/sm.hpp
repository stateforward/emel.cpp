...
struct model {
  auto operator()() const {
    ...
    return sml::make_transition_table(
      ...
      , sml::state<state_ready> <= sml::state<state_ready>
          + sml::event<event::execute_fwht_avx2>
          [ guard::guard_execute_fwht_avx2{} ]
          / action::effect_execute_fwht_avx2{}
      , sml::state<state_ready> <= sml::state<state_ready>
      ...
      , sml::state<state_ready> <= sml::state<state_ready>
          + sml::event<event::execute_prepared_avx2_dot_q4>
          [ guard::guard_execute_prepared_avx2_dot_q4{} ]
          / action::effect_execute_prepared_avx2_dot_q4{}
      , sml::state<state_ready> <= sml::state<state_ready>
