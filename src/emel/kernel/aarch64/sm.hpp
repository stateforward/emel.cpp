...
#include "emel/kernel/aarch64/guards.hpp"
    ...
    return sml::make_transition_table(
      ...
      // Dispatch event.
        sml::state<ready> <= *sml::state<ready> +
               sml::event<::emel::kernel::aarch64::event::dispatch_request>
                 / action::exec_dispatch

      //------------------------------------------------------------------------------//
      // Explicit op transitions.
      , sml::state<ready> <= sml::state<ready> +
               sml::event<::emel::kernel::aarch64::event::dispatch_op_dup>
                 [ guard::simd_op_dup{} ]
      ...
      , sml::state<ready> <= sml::state<ready> +
               sml::event<::emel::kernel::aarch64::event::dispatch_op_add_id>
      ...
      , sml::state<ready> <= sml::state<ready> +
               sml::event<::emel::kernel::aarch64::event::dispatch_op_add1>
                 [ guard::valid_op_add1{} ]
                 / action::exec_op_add1
      ...
      , sml::state<ready> <= sml::state<ready> +
               sml::event<::emel::kernel::aarch64::event::dispatch_op_acc>
                 [ guard::valid_op_acc{} ]
                 / action::exec_op_acc
      ...
      , sml::state<ready> <= sml::state<ready> +
               sml::event<::emel::kernel::aarch64::event::dispatch_op_sub>
                 [ guard::simd_op_sub{} ]
      ...
      , sml::state<ready> <= sml::state<ready> +
               sml::event<::emel::kernel::aarch64::event::dispatch_op_div>
                 [ guard::simd_op_div{} ]
      ...
      , sml::state<ready> <= sml::state<ready> +
               sml::event<::emel::kernel::aarch64::event::dispatch_op_sqr>
                 [ guard::simd_op_sqr{} ]
      ...
      , sml::state<ready> <= sml::state<ready> +
               sml::event<::emel::kernel::aarch64::event::dispatch_op_sqrt>
                 [ guard::simd_op_sqrt{} ]
      ...
      , sml::state<ready> <= sml::state<ready> +
               sml::event<::emel::kernel::aarch64::event::dispatch_op_log>
                 [ guard::valid_op_log{} ]
                 / action::exec_op_log
      ...
      , sml::state<ready> <= sml::state<ready> +
               sml::event<::emel::kernel::aarch64::event::dispatch_op_sin>
                 [ guard::valid_op_sin{} ]
                 / action::exec_op_sin
      ...
      , sml::state<ready> <= sml::state<ready> +
               sml::event<::emel::kernel::aarch64::event::dispatch_op_cos>
                 [ guard::valid_op_cos{} ]
                 / action::exec_op_cos
      ...
      , sml::state<ready> <= sml::state<ready> +
               sml::event<::emel::kernel::aarch64::event::dispatch_op_sum>
                 [ guard::valid_op_sum{} ]
                 / action::exec_op_sum
      ...
      , sml::state<ready> <= sml::state<ready> +
               sml::event<::emel::kernel::aarch64::event::dispatch_op_sum_rows>
      ...
      , sml::state<ready> <= sml::state<ready> +
               sml::event<::emel::kernel::aarch64::event::dispatch_op_cumsum>
      ...
      , sml::state<ready> <= sml::state<ready> +
               sml::event<::emel::kernel::aarch64::event::dispatch_op_mean>
                 [ guard::valid_op_mean{} ]
                 / action::exec_op_mean
      ...
      , sml::state<ready> <= sml::state<ready> +
               sml::event<::emel::kernel::aarch64::event::dispatch_op_argmax>
      ...
      , sml::state<ready> <= sml::state<ready> +
               sml::event<::emel::kernel::aarch64::event::dispatch_op_count_equal>
      ...
      , sml::state<ready> <= sml::state<ready> +
               sml::event<::emel::kernel::aarch64::event::dispatch_op_repeat>
      ...
      , sml::state<ready> <= sml::state<ready> +
               sml::event<::emel::kernel::aarch64::event::dispatch_op_repeat_back>
      ...
      , sml::state<ready> <= sml::state<ready> +
               sml::event<::emel::kernel::aarch64::event::dispatch_op_concat>
      ...
      , sml::state<ready> <= sml::state<ready> +
               sml::event<::emel::kernel::aarch64::event::dispatch_op_silu_back>
      ...
      , sml::state<ready> <= sml::state<ready> +
               sml::event<::emel::kernel::aarch64::event::dispatch_op_norm>
                 [ guard::valid_op_norm{} ]
                 / action::exec_op_norm
      ...
      , sml::state<ready> <= sml::state<ready> +
               sml::event<::emel::kernel::aarch64::event::dispatch_op_rms_norm>
      ...
      , sml::state<ready> <= sml::state<ready> +
               sml::event<::emel::kernel::aarch64::event::dispatch_op_rms_norm_back>
      ...
      , sml::state<ready> <= sml::state<ready> +
               sml::event<::emel::kernel::aarch64::event::dispatch_op_group_norm>
      ...
      , sml::state<ready> <= sml::state<ready> +
               sml::event<::emel::kernel::aarch64::event::dispatch_op_l2_norm>
      ...
      , sml::state<ready> <= sml::state<ready> +
               sml::event<::emel::kernel::aarch64::event::dispatch_op_mul_mat>
                 [ guard::simd_op_mul_mat_q5_0_vector{} ]
                 / action::exec_simd_op_mul_mat_q5_0_vector
      ...
      , sml::state<ready> <= sml::state<ready> +
               sml::event<::emel::kernel::aarch64::event::dispatch_op_mul_mat>
                 [ guard::simd_op_mul_mat_q4_vector_packed_q8_rhs_bl8_matrix_x8{} ]
                 / action::exec_simd_op_mul_mat_q4_vector_packed_q8_rhs_bl8_matrix_x8

      , sml::state<ready> <= sml::state<ready> +
               sml::event<::emel::kernel::aarch64::event::dispatch_op_mul_mat>
                 [ guard::simd_op_mul_mat_q4_vector_packed_q8_rhs_bl8_matrix_x4{} ]
                 / action::exec_simd_op_mul_mat_q4_vector_packed_q8_rhs_bl8_matrix_x4

      , sml::state<ready> <= sml::state<ready> +
               sml::event<::emel::kernel::aarch64::event::dispatch_op_mul_mat>
                 [ guard::simd_op_mul_mat_q4_vector_packed_q8_rhs_bl8{} ]
                 / action::exec_simd_op_mul_mat_q4_vector_packed_q8_rhs_bl8

      , sml::state<ready> <= sml::state<ready> +
               sml::event<::emel::kernel::aarch64::event::dispatch_op_mul_mat>
                 [ guard::simd_op_mul_mat_q4_vector_packed_f32_rhs_bl8{} ]
                 / action::exec_simd_op_mul_mat_q4_vector_packed_f32_rhs_bl8

      , sml::state<ready> <= sml::state<ready> +
               sml::event<::emel::kernel::aarch64::event::dispatch_op_mul_mat>
                 [ guard::simd_op_mul_mat_q4_vector_packed_q8_rhs_bl4_matrix_x4{} ]
                 / action::exec_simd_op_mul_mat_q4_vector_packed_q8_rhs_bl4_matrix_x4
      ...
      , sml::state<ready> <= sml::state<ready> +
               sml::event<::emel::kernel::aarch64::event::dispatch_op_mul_mat>
                 [ guard::simd_op_mul_mat_q4_vector_packed_f32_rhs_bl4{} ]
                 / action::exec_simd_op_mul_mat_q4_vector_packed_f32_rhs_bl4
      ...
      , sml::state<ready> <= sml::state<ready> +
               sml::event<::emel::kernel::aarch64::event::dispatch_op_mul_mat>
                 [ guard::simd_op_mul_mat_q4_vector_f32_rhs{} ]
                 / action::exec_simd_op_mul_mat_q4_vector_f32_rhs

      , sml::state<ready> <= sml::state<ready> +
               sml::event<::emel::kernel::aarch64::event::dispatch_op_mul_mat>
                 [ guard::simd_op_mul_mat_q6_vector_prepared_q8_rhs_i8mm_matrix_x8{} ]
                 / action::exec_simd_op_mul_mat_q6_vector_prepared_q8_rhs_i8mm_matrix_x8

      , sml::state<ready> <= sml::state<ready> +
               sml::event<::emel::kernel::aarch64::event::dispatch_op_mul_mat>
                 [ guard::simd_op_mul_mat_q6_vector_prepared_q8_rhs_i8mm_matrix_x4{} ]
                 / action::exec_simd_op_mul_mat_q6_vector_prepared_q8_rhs_i8mm_matrix_x4
      ...
      , sml::state<ready> <= sml::state<ready> +
               sml::event<::emel::kernel::aarch64::event::dispatch_op_mul_mat_argmax>
                 [ guard::simd_op_mul_mat_argmax_q4_vector_packed_f32_rhs_bl8{} ]
                 / action::exec_simd_op_mul_mat_argmax_q4_vector_packed_f32_rhs_bl8

      , sml::state<ready> <= sml::state<ready> +
               sml::event<::emel::kernel::aarch64::event::dispatch_op_mul_mat_argmax>
                 [ guard::simd_op_mul_mat_argmax_q4_vector_packed_f32_rhs_bl4{} ]
                 / action::exec_simd_op_mul_mat_argmax_q4_vector_packed_f32_rhs_bl4
      ...
      , sml::state<ready> <= sml::state<ready> +
               sml::event<::emel::kernel::aarch64::event::dispatch_op_mul_mat>
                 [ guard::simd_op_mul_mat_q6_vector_packed_q8_rhs_matrix_x4{} ]
                 / action::exec_simd_op_mul_mat_q6_vector_packed_q8_rhs_matrix_x4
      ...
      , sml::state<ready> <= sml::state<ready> +
               sml::event<::emel::kernel::aarch64::event::dispatch_op_out_prod>
      ...
      , sml::state<ready> <= sml::state<ready> +
               sml::event<::emel::kernel::aarch64::event::dispatch_op_scale>
      ...
      , sml::state<ready> <= sml::state<ready> +
               sml::event<::emel::kernel::aarch64::event::dispatch_op_set>
                 [ guard::valid_op_set{} ]
                 / action::exec_op_set
      ...
      , sml::state<ready> <= sml::state<ready> +
               sml::event<::emel::kernel::aarch64::event::dispatch_op_cpy>
                 [ guard::valid_op_cpy{} ]
                 / action::exec_op_cpy
      ...
      , sml::state<ready> <= sml::state<ready> +
               sml::event<::emel::kernel::aarch64::event::dispatch_op_cont>
                 [ guard::valid_op_cont{} ]
                 / action::exec_op_cont
      ...
      , sml::state<ready> <= sml::state<ready> +
               sml::event<::emel::kernel::aarch64::event::dispatch_op_reshape>
      ...
      , sml::state<ready> <= sml::state<ready> +
               sml::event<::emel::kernel::aarch64::event::dispatch_op_view>
                 [ guard::valid_op_view{} ]
                 / action::exec_op_view
      ...
      , sml::state<ready> <= sml::state<ready> +
               sml::event<::emel::kernel::aarch64::event::dispatch_op_permute>
      ...
      , sml::state<ready> <= sml::state<ready> +
               sml::event<::emel::kernel::aarch64::event::dispatch_op_transpose>
      ...
      , sml::state<ready> <= sml::state<ready> +
               sml::event<::emel::kernel::aarch64::event::dispatch_op_get_rows>
      ...
      , sml::state<ready> <= sml::state<ready> +
               sml::event<::emel::kernel::aarch64::event::dispatch_op_get_rows_back>
      ...
      , sml::state<ready> <= sml::state<ready> +
               sml::event<::emel::kernel::aarch64::event::dispatch_op_set_rows>
      ...
      , sml::state<ready> <= sml::state<ready> +
               sml::event<::emel::kernel::aarch64::event::dispatch_op_diag>
                 [ guard::valid_op_diag{} ]
                 / action::exec_op_diag
      ...
      , sml::state<ready> <= sml::state<ready> +
               sml::event<::emel::kernel::aarch64::event::dispatch_op_diag_mask_inf>
      ...
      , sml::state<ready> <= sml::state<ready> +
               sml::event<::emel::kernel::aarch64::event::dispatch_op_diag_mask_zero>
      ...
      , sml::state<ready> <= sml::state<ready> +
               sml::event<::emel::kernel::aarch64::event::dispatch_op_soft_max>
      ...
      , sml::state<ready> <= sml::state<ready> +
               sml::event<::emel::kernel::aarch64::event::dispatch_op_soft_max_back>
      ...
      , sml::state<ready> <= sml::state<ready> +
               sml::event<::emel::kernel::aarch64::event::dispatch_op_rope>
      ...
      , sml::state<ready> <= sml::state<ready> +
               sml::event<::emel::kernel::aarch64::event::dispatch_op_rope_back>
      ...
      , sml::state<ready> <= sml::state<ready> +
               sml::event<::emel::kernel::aarch64::event::dispatch_op_im2col>
      ...
      , sml::state<ready> <= sml::state<ready> +
               sml::event<::emel::kernel::aarch64::event::dispatch_op_im2col_back>
      ...
      , sml::state<ready> <= sml::state<ready> +
               sml::event<::emel::kernel::aarch64::event::dispatch_op_im2col_3d>
      ...
      , sml::state<ready> <= sml::state<ready> +
               sml::event<::emel::kernel::aarch64::event::dispatch_op_conv_2d>
      ...
      , sml::state<ready> <= sml::state<ready> +
               sml::event<::emel::kernel::aarch64::event::dispatch_op_conv_3d>
      ...
      , sml::state<ready> <= sml::state<ready> +
               sml::event<::emel::kernel::aarch64::event::dispatch_op_conv_2d_dw>
      ...
      , sml::state<ready> <= sml::state<ready> +
               sml::event<::emel::kernel::aarch64::event::dispatch_op_conv_transpose_2d>
      ...
      , sml::state<ready> <= sml::state<ready> +
               sml::event<::emel::kernel::aarch64::event::dispatch_op_pool_1d>
      ...
      , sml::state<ready> <= sml::state<ready> +
               sml::event<::emel::kernel::aarch64::event::dispatch_op_pool_2d>
      ...
      , sml::state<ready> <= sml::state<ready> +
               sml::event<::emel::kernel::aarch64::event::dispatch_op_pool_2d_back>
      ...
      , sml::state<ready> <= sml::state<ready> +
               sml::event<::emel::kernel::aarch64::event::dispatch_op_upscale>
      ...
      , sml::state<ready> <= sml::state<ready> +
               sml::event<::emel::kernel::aarch64::event::dispatch_op_pad>
                 [ guard::valid_op_pad{} ]
                 / action::exec_op_pad
      ...
      , sml::state<ready> <= sml::state<ready> +
               sml::event<::emel::kernel::aarch64::event::dispatch_op_pad_reflect_1d>
      ...
      , sml::state<ready> <= sml::state<ready> +
               sml::event<::emel::kernel::aarch64::event::dispatch_op_roll>
                 [ guard::valid_op_roll{} ]
                 / action::exec_op_roll
      ...
      , sml::state<ready> <= sml::state<ready> +
               sml::event<::emel::kernel::aarch64::event::dispatch_op_arange>
      ...
      , sml::state<ready> <= sml::state<ready> +
               sml::event<::emel::kernel::aarch64::event::dispatch_op_timestep_embedding>
      ...
      , sml::state<ready> <= sml::state<ready> +
               sml::event<::emel::kernel::aarch64::event::dispatch_op_argsort>
      ...
      , sml::state<ready> <= sml::state<ready> +
               sml::event<::emel::kernel::aarch64::event::dispatch_op_top_k>
      ...
      , sml::state<ready> <= sml::state<ready> +
               sml::event<::emel::kernel::aarch64::event::dispatch_op_leaky_relu>
      ...
      , sml::state<ready> <= sml::state<ready> +
               sml::event<::emel::kernel::aarch64::event::dispatch_op_tri>
                 [ guard::valid_op_tri{} ]
                 / action::exec_op_tri
      ...
      , sml::state<ready> <= sml::state<ready> +
               sml::event<::emel::kernel::aarch64::event::dispatch_op_fill>
                 [ guard::valid_op_fill{} ]
                 / action::exec_op_fill
      ...
      , sml::state<ready> <= sml::state<ready> +
               sml::event<::emel::kernel::aarch64::event::dispatch_op_flash_attn_back>
      ...
      , sml::state<ready> <= sml::state<ready> +
               sml::event<::emel::kernel::aarch64::event::dispatch_op_ssm_conv>
      ...
      , sml::state<ready> <= sml::state<ready> +
               sml::event<::emel::kernel::aarch64::event::dispatch_op_ssm_scan>
      ...
      , sml::state<ready> <= sml::state<ready> +
               sml::event<::emel::kernel::aarch64::event::dispatch_op_win_part>
      ...
      , sml::state<ready> <= sml::state<ready> +
               sml::event<::emel::kernel::aarch64::event::dispatch_op_win_unpart>
      ...
      , sml::state<ready> <= sml::state<ready> +
               sml::event<::emel::kernel::aarch64::event::dispatch_op_get_rel_pos>
      ...
      , sml::state<ready> <= sml::state<ready> +
               sml::event<::emel::kernel::aarch64::event::dispatch_op_add_rel_pos>
      ...
      , sml::state<ready> <= sml::state<ready> +
               sml::event<::emel::kernel::aarch64::event::dispatch_op_rwkv_wkv6>
      ...
      , sml::state<ready> <= sml::state<ready> +
               sml::event<::emel::kernel::aarch64::event::dispatch_op_gated_linear_attn>
      ...
      , sml::state<ready> <= sml::state<ready> +
               sml::event<::emel::kernel::aarch64::event::dispatch_op_rwkv_wkv7>
      ...
      , sml::state<ready> <= sml::state<ready> +
               sml::event<::emel::kernel::aarch64::event::dispatch_op_solve_tri>
      ...
      , sml::state<ready> <= sml::state<ready> +
               sml::event<::emel::kernel::aarch64::event::dispatch_op_unary>
                 [ guard::simd_op_unary_abs{} ]
                 / action::exec_simd_op_unary_abs

      , sml::state<ready> <= sml::state<ready> +
               sml::event<::emel::kernel::aarch64::event::dispatch_op_unary>
                 [ guard::simd_op_unary_neg{} ]
                 / action::exec_simd_op_unary_neg

      , sml::state<ready> <= sml::state<ready> +
               sml::event<::emel::kernel::aarch64::event::dispatch_op_unary>
                 [ guard::simd_op_unary_relu{} ]
                 / action::exec_simd_op_unary_relu
      ...
      , sml::state<ready> <= sml::state<ready> +
               sml::event<::emel::kernel::aarch64::event::dispatch_op_map_custom1>
      ...
      , sml::state<ready> <= sml::state<ready> +
               sml::event<::emel::kernel::aarch64::event::dispatch_op_map_custom2>
      ...
      , sml::state<ready> <= sml::state<ready> +
               sml::event<::emel::kernel::aarch64::event::dispatch_op_map_custom3>
      ...
      , sml::state<ready> <= sml::state<ready> +
               sml::event<::emel::kernel::aarch64::event::dispatch_op_custom>
      ...
      , sml::state<ready> <= sml::state<ready> +
               sml::event<::emel::kernel::aarch64::event::dispatch_op_cross_entropy_loss>
      ...
      , sml::state<ready> <= sml::state<ready> +
               sml::event<::emel::kernel::aarch64::event::dispatch_op_cross_entropy_loss_back>
      ...
      , sml::state<ready> <= sml::state<ready> +
               sml::event<::emel::kernel::aarch64::event::dispatch_op_opt_step_adamw>
      ...
      , sml::state<ready> <= sml::state<ready> +
               sml::event<::emel::kernel::aarch64::event::dispatch_op_opt_step_sgd>
      ...
      , sml::state<ready> <= sml::state<ready> +
               sml::event<::emel::kernel::aarch64::event::dispatch_op_glu>
                 [ guard::valid_op_glu{} ]
                 / action::exec_op_glu
...
struct sm : public emel::sm<model, action::context> {
  ...
  uint64_t optimized_q8_0_packed_bl8_matrix_x4_dispatch_count() const noexcept {
    return this->context_.optimized_q8_0_packed_bl8_matrix_x4_dispatch_count;
  }
  ...
  uint64_t optimized_q4_vector_dispatch_count() const noexcept {
    return this->context_.optimized_q4_vector_dispatch_count;
  }

  uint64_t optimized_q4_vector_packed_dispatch_count() const noexcept {
    return this->context_.optimized_q4_vector_packed_dispatch_count;
  }

  uint64_t optimized_q4_vector_packed_q8_rhs_dispatch_count() const noexcept {
    return this->context_.optimized_q4_vector_packed_q8_rhs_dispatch_count;
  }
