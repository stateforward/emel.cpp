...
inline constexpr int32_t k_sample_rate = emel::diarization::sortformer::request::detail::k_sample_rate;
inline constexpr int32_t k_channel_count = emel::diarization::sortformer::request::detail::k_channel_count;
