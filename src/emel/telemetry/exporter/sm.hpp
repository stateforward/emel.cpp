  ...
  auto operator()() const {
    ...
    return sml::make_transition_table(
      *sml::state<initialized> + sml::event<event::configure> / action::begin_configure =
      ...
      sml::state<configuring> + sml::event<sml::_> [not_anonymous] /
        action::on_unexpected = sml::state<errored>,
      sml::state<configure_decision> + sml::event<sml::_> [not_anonymous] /
        action::on_unexpected = sml::state<errored>,
      sml::state<starting> + sml::event<sml::_> [not_anonymous] /
        action::on_unexpected = sml::state<errored>,
      sml::state<start_decision> + sml::event<sml::_> [not_anonymous] /
        action::on_unexpected = sml::state<errored>,
      sml::state<running> + sml::event<sml::_> [not_anonymous] /
        action::on_unexpected = sml::state<errored>,
      sml::state<collecting> + sml::event<sml::_> [not_anonymous] /
        action::on_unexpected = sml::state<errored>,
      sml::state<collect_decision> + sml::event<sml::_> [not_anonymous] /
        action::on_unexpected = sml::state<errored>,
      sml::state<flushing> + sml::event<sml::_> [not_anonymous] /
        action::on_unexpected = sml::state<errored>,
      sml::state<flush_decision> + sml::event<sml::_> [not_anonymous] /
        action::on_unexpected = sml::state<errored>,
      sml::state<backing_off> + sml::event<sml::_> [not_anonymous] /
        action::on_unexpected = sml::state<errored>,
      sml::state<backoff_decision> + sml::event<sml::_> [not_anonymous] /
        action::on_unexpected = sml::state<errored>,
      sml::state<stopping> + sml::event<sml::_> [not_anonymous] /
        action::on_unexpected = sml::state<errored>,
      sml::state<stop_decision> + sml::event<sml::_> [not_anonymous] /
        action::on_unexpected = sml::state<errored>,
