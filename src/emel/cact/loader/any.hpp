...
inline constexpr uint32_t max_engram_orders =
    detail::constants::max_engram_orders;
inline constexpr uint32_t max_engram_sites =
    detail::constants::max_engram_sites;
...
inline constexpr uint32_t ternary_record_bits =
    detail::constants::ternary_record_bits;
