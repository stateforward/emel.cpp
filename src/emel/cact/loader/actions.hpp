...
inline constexpr effect_mark_probe_invalid_request effect_mark_probe_invalid_request{};
inline constexpr effect_mark_bind_invalid_request effect_mark_bind_invalid_request{};
inline constexpr effect_mark_parse_invalid_request effect_mark_parse_invalid_request{};
