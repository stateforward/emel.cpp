...
inline void assign_bpe_regex(action::context &ctx,
  ...
  switch (pre) {
    ...
    case TokenizerPre::JAIS2:
      ...
      return;
    case TokenizerPre::DBRX:
    case TokenizerPre::SMAUG:
      set_regex({
          "(?:'[sS]|'[tT]|'[rR][eE]|'[vV][eE]|'[mM]|'[lL][lL]|'[dD])|"
          "[^\\r\\n\\p{L}\\p{N}]?\\p{L}+|\\p{N}{1,3}| ?[^\\s\\p{L}\\p{N}]+"
          "[\\r\\n]*|\\s*[\\r\\n]+|\\s+(?!\\S)|\\s+",
      ...
      return;
    case TokenizerPre::DEEPSEEK_LLM:
      set_regex({
          "[\\r\\n]",
      ...
      return;
    case TokenizerPre::DEEPSEEK3_LLM:
    case TokenizerPre::HUNYUAN_DENSE:
    case TokenizerPre::JOYAI_LLM:
      set_regex({
          "\\p{N}{1,3}",
    ...
    case TokenizerPre::YOUTU:
      ...
      return;
    case TokenizerPre::DEEPSEEK_CODER:
      set_regex({
          "[\\r\\n]",
          "\\s?\\p{L}+",
          "\\s?\\p{P}+",
    ...
    case TokenizerPre::FALCON:
      ...
      return;
    case TokenizerPre::STARCODER:
    case TokenizerPre::REFACT:
    case TokenizerPre::COMMAND_R:
    case TokenizerPre::SMOLLM:
    case TokenizerPre::CODESHELL:
    case TokenizerPre::EXAONE:
    case TokenizerPre::MINERVA:
      set_regex({
          "\\p{N}",
          "'s|'t|'re|'ve|'m|'ll|'d| ?\\p{L}+| ?\\p{N}+| ?[^\\s\\p{L}\\p{N}]+|\\s+(?!\\S)",
      });
      return;
    case TokenizerPre::GPT2:
    case TokenizerPre::MPT:
    case TokenizerPre::OLMO:
    case TokenizerPre::JAIS:
    case TokenizerPre::TRILLION:
    case TokenizerPre::GRANITE_DOCLING:
      set_regex({
          "'s|'t|'re|'ve|'m|'ll|'d| ?\\p{L}+| ?\\p{N}+| ?[^\\s\\p{L}\\p{N}]+|\\s+(?!\\S)",
      });
      return;
    case TokenizerPre::QWEN35:
      set_regex({
          "(?:'[sS]|'[tT]|'[rR][eE]|'[vV][eE]|'[mM]|'[lL][lL]|'[dD])|"
      ...
      return;
    case TokenizerPre::STABLELM2:
    case TokenizerPre::QWEN2:
    case TokenizerPre::HUNYUAN:
    case TokenizerPre::SOLAR_OPEN:
      set_regex({
          "(?:'[sS]|'[tT]|'[rR][eE]|'[vV][eE]|'[mM]|'[lL][lL]|'[dD])|"
      ...
      return;
    case TokenizerPre::PORO:
    case TokenizerPre::BLOOM:
    case TokenizerPre::GPT3_FINNISH:
      set_regex({
          " ?[^(\\\\s|.,!?\\xe2\\x80\\xa6\\xe3\\x80\\x82\\xef\\xbc\\x8c\\xe3\\x80\\x81\\xe0\\xa5\\xa4\\xe0\\xa5\\xa4\\xd8\\x8c)]+",
      });
      return;
    case TokenizerPre::CHATGLM4:
      set_regex({
          "(?:'[sS]|'[tT]|'[rR][eE]|'[vV][eE]|'[mM]|'[lL][lL]|'[dD])|"
          "[^\\r\\n\\p{L}\\p{N}]?\\p{L}+|\\p{N}{1,3}| ?[^\\s\\p{L}\\p{N}]+"
          "[\\r\\n]*|\\s*[\\r\\n]+|\\s+(?!\\S)|\\s+",
      ...
      return;
    case TokenizerPre::VIKING:
      set_regex({
          " ?[^(\\\\s|.,!?\\xe2\\x80\\xa6\\xe3\\x80\\x82\\xef\\xbc\\x8c\\xe3\\x80\\x81\\xe0\\xa5\\xa4\\xe0\\xa5\\xa4\\xd8\\x8c)]+",
          "\\p{N}",
      });
      return;
    case TokenizerPre::TEKKEN:
      set_regex({
    ...
    case TokenizerPre::CHAMELEON:
      ...
      return;
    case TokenizerPre::GPT4O:
    case TokenizerPre::MINIMAX_M2:
      set_regex({
          "[^\\r\\n\\p{L}\\p{N}]?((?=[\\p{L}])([^a-z]))*((?=[\\p{L}])([^A-Z]))+"
          "(?:'[sS]|'[tT]|'[rR][eE]|'[vV][eE]|'[mM]|'[lL][lL]|'[dD])?|"
          "[^\\r\\n\\p{L}\\p{N}]?((?=[\\p{L}])([^a-z]))+((?=[\\p{L}])([^A-Z]))*"
    ...
    case TokenizerPre::TINY_AYA:
      ...
      return;
    case TokenizerPre::KIMI_K2:
      set_regex({
          "\\p{Han}+",
      });
      return;
    case TokenizerPre::SUPERBPE:
      set_regex({
          "\\p{N}+",
          "(?=(\\d{3})+(?!\\d))",
      });
      return;
    case TokenizerPre::BAILINGMOE:
      set_regex({
          "'(?:[sSdDmMtT]|[lL][lL]|[vV][eE]|[rR][eE])|[^\\r\\n\\p{L}\\p{N}]?"
          "\\p{L}+|\\p{N}| ?[^\\s\\p{L}\\p{N}]+[\\r\\n]*|\\s*[\\r\\n]|\\s+(?!\\S)|\\s+",
      });
      return;
    case TokenizerPre::SEED_CODER:
      set_regex({
          "(?:'[sS]|'[tT]|'[rR][eE]|'[vV][eE]|'[mM]|'[lL][lL]|'[dD])|"
