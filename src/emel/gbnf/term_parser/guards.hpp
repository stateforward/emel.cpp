...
namespace emel::gbnf::term_parser::guard {

inline bool token_is(const rule_parser::event::parse_rules & ev,
                     const emel::gbnf::lexer::event::token_kind kind) noexcept {
...
struct token_string_literal {
  bool operator()(const rule_parser::event::parse_rules & ev,
    ...
    return token_is(ev, emel::gbnf::lexer::event::token_kind::string_literal);
  }
};
...
struct token_character_class {
  bool operator()(const rule_parser::event::parse_rules & ev,
                  const action::context &) const noexcept {
    return token_is(ev, emel::gbnf::lexer::event::token_kind::character_class);
  }
};
...
struct token_rule_reference {
  bool operator()(const rule_parser::event::parse_rules & ev,
                  const action::context &) const noexcept {
    return token_is(ev, emel::gbnf::lexer::event::token_kind::rule_reference);
  }
};
...
struct token_dot {
  bool operator()(const rule_parser::event::parse_rules & ev,
                  const action::context &) const noexcept {
    return token_is(ev, emel::gbnf::lexer::event::token_kind::dot);
  }
};
...
struct token_open_group {
  bool operator()(const rule_parser::event::parse_rules & ev,
                  const action::context &) const noexcept {
    return token_is(ev, emel::gbnf::lexer::event::token_kind::open_group);
  }
};
...
struct token_close_group {
  bool operator()(const rule_parser::event::parse_rules & ev,
                  const action::context &) const noexcept {
    return token_is(ev, emel::gbnf::lexer::event::token_kind::close_group);
  }
};
...
struct token_quantifier {
  bool operator()(const rule_parser::event::parse_rules & ev,
                  const action::context &) const noexcept {
    return token_is(ev, emel::gbnf::lexer::event::token_kind::quantifier);
  }
};
...
struct token_alternation {
  bool operator()(const rule_parser::event::parse_rules & ev,
                  const action::context &) const noexcept {
    return token_is(ev, emel::gbnf::lexer::event::token_kind::alternation);
  }
};
...
struct token_newline {
  bool operator()(const rule_parser::event::parse_rules & ev,
                  const action::context &) const noexcept {
    return token_is(ev, emel::gbnf::lexer::event::token_kind::newline);
  }
};
