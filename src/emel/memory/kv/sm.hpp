  ...
  auto operator()() const {
    ...
    return sml::make_transition_table(
      ...
      , sml::state<allocate_sequence_exec> <= sml::state<allocate_sequence_request_decision>
          ...
          [ guard::allocate_sequence_request_valid{} ]
      ...
      , sml::state<allocate_sequence_result_decision> <= sml::state<allocate_sequence_exec>
          + sml::completion<event::allocate_sequence_runtime> / action::exec_allocate_sequence
      ...
      , sml::state<allocate_slots_exec> <= sml::state<allocate_slots_request_decision>
          + sml::completion<event::allocate_slots_runtime> [ guard::allocate_slots_request_valid{} ]
      , sml::state<errored> <= sml::state<allocate_slots_request_decision>
          + sml::completion<event::allocate_slots_runtime>
          [ guard::allocate_slots_request_out_of_memory{} ]
          / action::mark_out_of_memory
      , sml::state<errored> <= sml::state<allocate_slots_request_decision>
          + sml::completion<event::allocate_slots_runtime>
          [ guard::allocate_slots_request_backend_error{} ]
          / action::mark_backend_error
      , sml::state<errored> <= sml::state<allocate_slots_request_decision>
          + sml::completion<event::allocate_slots_runtime> [ guard::allocate_slots_request_invalid{} ]
          / action::mark_invalid_request
      ...
      , sml::state<branch_sequence_exec> <= sml::state<branch_sequence_request_decision>
          + sml::completion<event::branch_sequence_runtime>
          [ guard::branch_sequence_request_valid{} ]
      , sml::state<errored> <= sml::state<branch_sequence_request_decision>
          + sml::completion<event::branch_sequence_runtime>
          [ guard::branch_sequence_request_invalid{} ]
          / action::mark_invalid_request
      , sml::state<branch_sequence_result_decision> <= sml::state<branch_sequence_exec>
          + sml::completion<event::branch_sequence_runtime> / action::exec_branch_sequence
      , sml::state<done> <= sml::state<branch_sequence_result_decision>
          + sml::completion<event::branch_sequence_runtime> [ guard::operation_succeeded{} ]
      , sml::state<errored> <= sml::state<branch_sequence_result_decision>
          + sml::completion<event::branch_sequence_runtime> [ guard::operation_failed_with_error{} ]
          / action::mark_error_from_operation
      , sml::state<errored> <= sml::state<branch_sequence_result_decision>
          + sml::completion<event::branch_sequence_runtime> [ guard::operation_failed_without_error{} ]
          / action::mark_backend_error
      ...
      , sml::state<free_sequence_exec> <= sml::state<free_sequence_request_decision>
          + sml::completion<event::free_sequence_runtime> [ guard::free_sequence_request_valid{} ]
      ...
      , sml::state<free_sequence_result_decision> <= sml::state<free_sequence_exec>
          + sml::completion<event::free_sequence_runtime> / action::exec_free_sequence
