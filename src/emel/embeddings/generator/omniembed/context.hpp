...
struct text_runtime {
  bool ready = false;
  emel::embeddings::generator::action::text_route_kind route_kind =
      emel::embeddings::generator::action::text_route_kind::none;
...
struct image_runtime {
  ...
  bool ready = false;
  emel::embeddings::generator::action::image_route_kind route_kind =
      emel::embeddings::generator::action::image_route_kind::none;
  int32_t input_size = 0;
...
struct audio_runtime {
  ...
  bool ready = false;
  emel::embeddings::generator::action::audio_route_kind route_kind =
      emel::embeddings::generator::action::audio_route_kind::none;
...
namespace emel::embeddings::generator::omniembed::action {

using audio_conv_norm_runtime = emel::embeddings::generator::omniembed::audio_conv_norm_runtime;
using audio_inverted_residual_runtime =
    emel::embeddings::generator::omniembed::audio_inverted_residual_runtime;
using audio_route_kind = emel::embeddings::generator::action::audio_route_kind;
using audio_runtime = emel::embeddings::generator::omniembed::audio_runtime;
using batch_norm_view = emel::embeddings::generator::omniembed::batch_norm_view;
using context = emel::embeddings::generator::action::context;
using conv_norm_runtime = emel::embeddings::generator::omniembed::conv_norm_runtime;
using conv2d_view = emel::embeddings::generator::omniembed::conv2d_view;
using edge_residual_runtime = emel::embeddings::generator::omniembed::edge_residual_runtime;
using embedding_execution_contract =
    emel::embeddings::generator::action::embedding_execution_contract;
using image_route_kind = emel::embeddings::generator::action::image_route_kind;
using image_runtime = emel::embeddings::generator::omniembed::image_runtime;
using layer_weights = emel::embeddings::generator::omniembed::layer_weights;
using matrix_view = emel::embeddings::generator::omniembed::matrix_view;
using projection_runtime = emel::embeddings::generator::omniembed::projection_runtime;
using runtime_state = emel::embeddings::generator::omniembed::runtime_state;
using scratch_buffers = emel::embeddings::generator::omniembed::scratch_buffers;
using squeeze_excitation_runtime =
    emel::embeddings::generator::omniembed::squeeze_excitation_runtime;
using text_route_kind = emel::embeddings::generator::action::text_route_kind;
using text_runtime = emel::embeddings::generator::omniembed::text_runtime;
using universal_inverted_runtime =
    emel::embeddings::generator::omniembed::universal_inverted_runtime;
using vector_view = emel::embeddings::generator::omniembed::vector_view;

inline constexpr int32_t k_max_text_layers =
    emel::embeddings::generator::omniembed::k_max_text_layers;
