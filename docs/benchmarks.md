...
| `generation/preloaded_request/lfm2_5_1_2b_thinking_q4_k_m_prompt_hello_max_tokens_1` | 376517541.000 | llama.cpp | 324872666.000 | 1.159x |
| `generation/preloaded_request/lfm2_5_1_2b_thinking_q4_k_m_prompt_hello_max_tokens_10` | 445531625.000 | llama.cpp | 553302250.000 | 0.805x |
| `generation/preloaded_request/lfm2_5_1_2b_thinking_q4_k_m_prompt_hello_max_tokens_100` | 1345877750.000 | llama.cpp | 2890410167.000 | 0.466x |
| `generation/preloaded_request/lfm2_5_1_2b_thinking_q4_k_m_prompt_hello_max_tokens_1000` | 12007452583.000 | llama.cpp | 27184679500.000 | 0.442x |
| `generation/preloaded_request/lfm2_5_230m_q8_0_prompt_hello_max_tokens_1` | 20592250.000 | llama.cpp | 39528375.000 | 0.521x |
| `generation/preloaded_request/lfm2_5_230m_q8_0_prompt_hello_max_tokens_100` | 284261041.000 | llama.cpp | 460871583.000 | 0.617x |
...
- `generation` fixture `Qwen3-0.6B-Q8_0.gguf` rows: `source=previous_snapshot`, `reason=fixture_absent_on_2026_07_05_arm64_refresh`.
