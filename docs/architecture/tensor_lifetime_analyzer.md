...
stateDiagram-v2
  ...
  validating --> boost::sml::front::internal : on_entry [boost::sml::front::always] / boost::sml::aux::zero_wrapper<(lambda at /Users/gabrielwillen/VSCode/stateforward/emel/emel.cpp/src/emel/tensor/lifetime_analyzer/sm.hpp:62:11)>
  ...
  collecting_ranges --> boost::sml::front::internal : on_entry [boost::sml::front::always] / boost::sml::aux::zero_wrapper<(lambda at /Users/gabrielwillen/VSCode/stateforward/emel/emel.cpp/src/emel/tensor/lifetime_analyzer/sm.hpp:96:11)>
  ...
  publishing --> boost::sml::front::internal : on_entry [boost::sml::front::always] / boost::sml::aux::zero_wrapper<(lambda at /Users/gabrielwillen/VSCode/stateforward/emel/emel.cpp/src/emel/tensor/lifetime_analyzer/sm.hpp:127:11)>
  ...
  done --> boost::sml::front::internal : on_entry [boost::sml::front::always] / boost::sml::aux::zero_wrapper<(lambda at /Users/gabrielwillen/VSCode/stateforward/emel/emel.cpp/src/emel/tensor/lifetime_analyzer/sm.hpp:159:11)>
  ...
  done --> idle : emel::tensor::lifetime_analyzer::events::analyze_error [boost::sml::front::always] / boost::sml::aux::zero_wrapper<emel::tensor::lifetime_analyzer::action::on_analyze_error>
  ...
  resetting --> boost::sml::front::internal : on_entry [boost::sml::front::always] / boost::sml::aux::zero_wrapper<(lambda at /Users/gabrielwillen/VSCode/stateforward/emel/emel.cpp/src/emel/tensor/lifetime_analyzer/sm.hpp:179:11)>
  ...
  failed --> boost::sml::front::internal : on_entry [boost::sml::front::always] / boost::sml::aux::zero_wrapper<(lambda at /Users/gabrielwillen/VSCode/stateforward/emel/emel.cpp/src/emel/tensor/lifetime_analyzer/sm.hpp:190:11)>
...
| `validating` | `on_entry` | `boost::sml::front::always` | `boost::sml::aux::zero_wrapper<(lambda at /Users/gabrielwillen/VSCode/stateforward/emel/emel.cpp/src/emel/tensor/lifetime_analyzer/sm.hpp:62:11)>` | `boost::sml::front::internal` |
...
| `collecting_ranges` | `on_entry` | `boost::sml::front::always` | `boost::sml::aux::zero_wrapper<(lambda at /Users/gabrielwillen/VSCode/stateforward/emel/emel.cpp/src/emel/tensor/lifetime_analyzer/sm.hpp:96:11)>` | `boost::sml::front::internal` |
...
| `publishing` | `on_entry` | `boost::sml::front::always` | `boost::sml::aux::zero_wrapper<(lambda at /Users/gabrielwillen/VSCode/stateforward/emel/emel.cpp/src/emel/tensor/lifetime_analyzer/sm.hpp:127:11)>` | `boost::sml::front::internal` |
...
| `done` | `on_entry` | `boost::sml::front::always` | `boost::sml::aux::zero_wrapper<(lambda at /Users/gabrielwillen/VSCode/stateforward/emel/emel.cpp/src/emel/tensor/lifetime_analyzer/sm.hpp:159:11)>` | `boost::sml::front::internal` |
...
| `done` | `emel::tensor::lifetime_analyzer::events::analyze_error` | `boost::sml::front::always` | `boost::sml::aux::zero_wrapper<emel::tensor::lifetime_analyzer::action::on_analyze_error>` | `idle` |
...
| `resetting` | `on_entry` | `boost::sml::front::always` | `boost::sml::aux::zero_wrapper<(lambda at /Users/gabrielwillen/VSCode/stateforward/emel/emel.cpp/src/emel/tensor/lifetime_analyzer/sm.hpp:179:11)>` | `boost::sml::front::internal` |
...
| `failed` | `on_entry` | `boost::sml::front::always` | `boost::sml::aux::zero_wrapper<(lambda at /Users/gabrielwillen/VSCode/stateforward/emel/emel.cpp/src/emel/tensor/lifetime_analyzer/sm.hpp:190:11)>` | `boost::sml::front::internal` |
