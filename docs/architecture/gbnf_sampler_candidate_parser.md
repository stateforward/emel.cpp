...
stateDiagram-v2
  direction TB
  [*] --> deciding
  deciding --> parsed : completion [has_apply_text_] / consume_text_
  deciding --> parsed : completion [has_empty_apply_text_] / consume_empty_
