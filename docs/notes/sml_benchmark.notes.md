# stateforward.SML benchmark notes

## dispatch overhead (sml vs naive)

Built and ran:
- `benchmark/connection/stateforward_sml.cpp`
...
- `stateforward_sml`: mean 6.617205, median 6.617472

## relative to `naive_if_else`
- `stateforward_sml`: +0.174% mean, +2.870% median
...
*Raw outputs are in:*
- `@../../../../../../tmp/sml_bench/stateforward_sml.json`
