...
stateDiagram-v2
  direction TB
  [*] --> deciding
  deciding --> parsed : completion_sample_runtime_ [token_text_] / consume_match_accepted_
  deciding --> parsed : completion_sample_runtime_ [token_empty_] / consume_match_rejected_
