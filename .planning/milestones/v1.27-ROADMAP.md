...
- ✅ **v1.27 co_sm Cooperative Async I/O Strategy** — completed 2026-05-09,
  issue #64

## Phases

### ✅ v1.27 co_sm Cooperative Async I/O Strategy (Phases 239-252) — COMPLETE
...
**Milestone progress (v1.27):** **14 / 14** phases complete.

**Current audit status:** Phases 249-251 closed the scheduler/resource error, public loader
resumability, and evidence-consistency gaps reopened by the audit. Phase 250 renewed maintained
`cooperative_async` benchmark/compare evidence after preserving loader-level partial progress:
`416407417 ns/op` EMEL vs `319636708 ns/op` reference (`1.303x`) for the selected generation
case. Phase 252 closed `PERF-02` with constrained-RAM emulation through the maintained public
model-loader -> `io/loader` -> tensor path: 64 KiB windows required 11,165 load dispatches and
26,901,458 ns load time, while the scoped 1 MiB window run required 780 dispatches and
23,317,750 ns load time on the same publication fixture.
...
- [x] Phase 249: Runtime Scheduler Error Contract Repair (AIO-06) (completed 2026-05-09)
- [x] Phase 250: Public Loader Resumable Async Progress (AIO-04, TNX-03, PERF-01) (completed 2026-05-09)
- [x] Phase 251: Milestone Evidence Consistency Repair (DOC-01, EVI-01) (completed 2026-05-09)
- [x] Phase 252: Large-Model Constrained-RAM Profiling And Optimization (PERF-02) (completed 2026-05-09)
...
Plans:
- [x] 01 — Milestone evidence consistency repair
...
strategy.
**Plans:** 01 — Completed 2026-05-09; added maintained generation load-profile metadata for
`cooperative_async`, constrained the async chunk/window from benchmark env, and recorded same-path
64 KiB vs 1 MiB profiling evidence.
...
Mapped: 32/32 v1.27 requirements; satisfied 32, pending 0.
...
| 247. Publication and Evidence Truthfulness | v1.27 | 1/1 | Complete | 2026-05-09 |
| 248. Maintained Cooperative Async E2E Execution Path | v1.27 | 1/1 | Complete | 2026-05-09 |
| 249. Runtime Scheduler Error Contract Repair | v1.27 | 1/1 | Complete    | 2026-05-09 |
| 250. Public Loader Resumable Async Progress | v1.27 | 1/1 | Complete    | 2026-05-09 |
| 251. Milestone Evidence Consistency Repair | v1.27 | 1/1 | Complete    | 2026-05-09 |
| 252. Large-Model Constrained-RAM Profiling And Optimization | v1.27 | 1/1 | Complete    | 2026-05-09 |
