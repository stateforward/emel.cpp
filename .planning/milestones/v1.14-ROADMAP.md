...
- [x] **Phase 77: Benchmark Variant Registry Contract** - Define the shared variant registry
  shape, validation semantics, and deterministic ordering guarantees used by both generation and
  embedding benchmarks.
- [x] **Phase 78: Generation Workload Discovery Cutover** - Replace generation workload hard-coded
  manifest arrays with deterministic manifest discovery.
- [x] **Phase 79: Embedding Variant Discovery Cutover** - Move embedding benchmark case identity
  and maintained variant metadata out of code-owned case lists into deterministic registry data.
- [x] **Phase 80: Variant Addition Proof And Docs** - Prove and document the data-only add path
  for both benchmark families.
...
|-----------|--------|----------------|--------|-----------|
| v1.14 Benchmark Variant Organization | 77-80 | 4/4 | Complete | 2026-04-21 |
| v1.13 Pluggable Generative Parity Bench | 69-76 | 8/8 | Shipped | 2026-04-21 |

## Next Up

Run `$gsd-audit-milestone` and `$gsd-complete-milestone` to archive v1.14.
