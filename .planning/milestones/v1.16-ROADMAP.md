...
- [x] [v1.16: ARM Whisper GGUF Parity And Performance](.planning/milestones/v1.16-ROADMAP.md)
  - Initial archive created 2026-04-26, reopened the same day because bounded transcript drift was
    ...
    latest source-backed audit found remaining compare-gate, harness-boundary, policy, and
    Nyquist-ledger gaps now planned in Phases 117-119.
...
- The final milestone audit reports `status: passed`.
