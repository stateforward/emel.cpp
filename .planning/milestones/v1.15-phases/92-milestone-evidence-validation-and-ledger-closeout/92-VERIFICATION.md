...
| `RUN-02` | `92-01` | Runtime behavior choices remain explicit in Stateforward.SML guards, states, and transitions. | passed | Phase 91 summary lists `RUN-02`; Phase 91 verification cites request/executor guarded publication states. |
