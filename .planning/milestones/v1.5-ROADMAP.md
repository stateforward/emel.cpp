...
- [x] **Phase 25.1: Restore Canonical Flash-Attention Dispatch On The Maintained Generator Path**
...
- [x] 25.1-02: Refresh stored benchmark/docs artifacts after explicit approval so checked-in
...
| 25.1. Restore canonical flash-attention dispatch on the maintained generator path | 2/2 | Complete | 2026-03-27 |
