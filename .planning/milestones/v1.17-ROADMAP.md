...
- [x] **Phase 146: Text Generator Explicit Compute Outcome Modeling Closure** - Move audited
  ...
  `detail.hpp` wrappers and into explicit Stateforward.SML behavior.
...
Stateforward.SML guards/transitions rather than hidden in action-called `detail.hpp` callbacks.
