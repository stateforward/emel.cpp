...
- [x] [v1.12: Pluggable Reference Parity Bench Architecture](/Users/gabrielwillen/VSCode/stateforward/emel/emel.cpp/.planning/milestones/v1.12-ROADMAP.md) - shipped 2026-04-18 with a canonical pluggable compare contract, maintained Python and C++ reference backends, repaired multi-record C++ publication, and a passing rerun milestone audit.

## Current Milestone

No active milestone is defined.

Run `$gsd-new-milestone` to define the next scope and create a fresh `.planning/REQUIREMENTS.md`.
