...
- [x] [v1.18: Parity Tool Boundary Refactor](.planning/milestones/v1.18-ROADMAP.md)
  - Shipped 2026-05-01 with explicit paritychecker runner, engine, build-registration, manifest,
    behavior-preservation, and lane-isolation boundaries. Audit passed with `12/12` requirements
    satisfied.
