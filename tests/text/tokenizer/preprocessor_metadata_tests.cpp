...
TEST_CASE("preprocessor_detail_maps_tokenizer_pre_profiles") {
  constexpr auto cases = std::to_array<pre_case>({
      ...
      {"qwen2.5", tokenizer_pre::QWEN35, false, false},
      ...
      {"exaone4", tokenizer_pre::EXAONE4, false, false},
      ...
      {"gpt4o", tokenizer_pre::GPT4O, false, false},
      ...
      {"hunyuan", tokenizer_pre::HUNYUAN, false, false},
