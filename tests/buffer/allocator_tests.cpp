...
TEST_CASE("buffer_allocator_multi_buffer_alloc_graph_allows_changed_assignment_snapshot") {
  emel::buffer::allocator::sm machine{};
  initialize_ready(machine, 2);
