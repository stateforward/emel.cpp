...
TEST_CASE("tokenizer_preprocessor_rwkv_parse_special_true") {
  emel::model::data::vocab vocab = make_rwkv_vocab_with_specials();
...
TEST_CASE("tokenizer_preprocessor_rwkv_parse_special_false") {
  emel::model::data::vocab vocab = make_rwkv_vocab_with_specials();
