...
- [`.planning/architecture/kernel_cuda.md`](.planning/architecture/kernel_cuda.md)
- [`.planning/architecture/kernel_metal.md`](.planning/architecture/kernel_metal.md)
- [`.planning/architecture/kernel_vulkan.md`](.planning/architecture/kernel_vulkan.md)
- [`.planning/architecture/kernel_wasm.md`](.planning/architecture/kernel_wasm.md)
